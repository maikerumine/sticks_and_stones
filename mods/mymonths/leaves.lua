...
for i, name in pairs(leaves_table) do
  minetest.register_node('mymonths:leaves_' .. name, {
	  ...
	  drop = "default:stick",
      groups = {snappy = 3, leafdecay = 3, flammable = 2, leaves = 1, flora = 1, dig_by_water = 1},
...
for i = 1, 4 do
  minetest.register_node('mymonths:fall_leaves_'..i, {
      ...
      groups = {oddly_breakable_by_hand = 1, flammable = 2, attached_node = 1, fallen_leaves = 1, dig_by_water = 1},
      paramtype = 'light',
      walkable = false,
      buildable_to = true,
...
minetest.register_node('mymonths:leaf_pile', {
    ...
    groups = {oddly_breakable_by_hand = 1, flammable = 2, attached_node = 1, plant_fiber = 1, dig_by_water = 1},
    paramtype = 'light',
    walkable = false,
    buildable_to = true,
    selection_box = {
