...
minetest.register_node("sas_core:dirt_with_leaves_1", {
...
minetest.register_node("sas_core:dirt_with_leaves_2", {
...
minetest.register_node("sas_core:grass_with_leaves_1", {
...
minetest.register_node("sas_core:grass_with_leaves_2", {
...
minetest.register_alias("forestsoils:dirt_with_leaves_1",	"sas_core:dirt_with_leaves_1")
minetest.register_alias("forestsoils:dirt_with_leaves_2",	"sas_core:dirt_with_leaves_2")
minetest.register_alias("forestsoils:grass_with_leaves_1",	"sas_core:grass_with_leaves_1")
minetest.register_alias("forestsoils:grass_with_leaves_2",	"sas_core:grass_with_leaves_2")
...
--  e = + , n = +
sas_core.place_soil = function(pos)
	...
	or minetest.get_item_group(minetest.get_node({x=pos.x,y=pos.y-2,z=pos.z}).name, "soil") > 0 then
		for i in pairs(RaDiuS) do
			...
			if minetest.get_item_group(minetest.get_node(radius_1a).name, "soil") > 0 then
				minetest.set_node(radius_1a, {name="sas_core:dirt_with_leaves_1"})
			end
			if minetest.get_item_group(minetest.get_node(radius_1b).name, "soil") > 0 then
				minetest.set_node(radius_1b, {name="sas_core:dirt_with_leaves_1"})
			end
			-- Grass with Leaves 2
			if string.find(node_2a.name, "dirt_with_grass") then
				minetest.set_node(radius_2a, {name="sas_core:grass_with_leaves_2"})
			end
			if string.find(node_2b.name, "dirt_with_grass") then
				minetest.set_node(radius_2b, {name="sas_core:grass_with_leaves_2"})
			end
			-- Grass with Leaves 1
			if string.find(node_3a.name, "dirt_with_grass") then
				minetest.set_node(radius_3a, {name="sas_core:grass_with_leaves_1"})
			end
			if string.find(node_3b.name, "dirt_with_grass") then
				minetest.set_node(radius_3b, {name="sas_core:grass_with_leaves_1"})
			end
		end
	end
end
