...
doors.register("door_wood", {
		...
		recipe = {
			{"sas_core:iron_hinge", "group:wood", "group:wood"},
			{"sas_core:iron_hardware", "group:wood", "group:wood"},
			{"sas_core:iron_hinge", "group:wood", "group:wood"},
		}
})
...
doors.register("door_steel", {
		...
		recipe = {
			{"sas_core:iron_hinge", "sas_core:steel_plate", "sas_core:steel_plate"},
			{"sas_core:iron_hardware", "sas_core:steel_plate", "sas_core:steel_plate"},
			{"sas_core:iron_hinge", "sas_core:steel_plate", "sas_core:steel_plate"},
		}
})
--[[
...
minetest.register_craft({
	...
	recipe = {
		...
		{'group:wood', 'group:wood', ''},
		{'sas_core:iron_hardware', 'sas_core:iron_hinge', ''},
	}
})
...
function doors.register_fencegate(name, def)
	...
	minetest.register_craft({
		output = name .. "_closed",
		recipe = {
			{"sas_core:iron_hinge", "sas_core:iron_hardware", ""},
