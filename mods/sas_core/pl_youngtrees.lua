...
minetest.register_node("sas_core:bamboo", {
...
minetest.register_node("sas_core:youngtree2_middle",{
...
minetest.register_node("sas_core:youngtree_top", {
...
minetest.register_node("sas_core:youngtree_middle", {
...
minetest.register_node("sas_core:youngtree_bottom", {
 ...
 sas_core.grow_youngtree = function(pos)
	local height = math.random(1,3)	
	sas_core.grow_youngtree_node(pos,height)
end

sas_core.grow_youngtree_node = function(pos, height)
	...
	or minetest.get_node(right_here).name == "default:junglegrass" then
		if height == 1 then
				minetest.set_node(right_here, {name="sas_core:youngtree_top"})
		end
		if height == 2 then
				minetest.set_node(right_here, {name="sas_core:youngtree_bottom"})
				minetest.set_node(above_right_here, {name="sas_core:youngtree_top"})
		end	
		if height == 3 then
				local two_above_right_here = {x=pos.x, y=pos.y+3, z=pos.z}
				minetest.set_node(right_here, {name="sas_core:youngtree_bottom"})
				minetest.set_node(above_right_here, {name="sas_core:youngtree_middle"})
				minetest.set_node(two_above_right_here, {name="sas_core:youngtree_top"})
		end		
	end
end
