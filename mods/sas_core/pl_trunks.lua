...
dofile(minetest.get_modpath("sas_core").."/trunks_settings.txt")
--dofile(minetest.get_modpath("sas_core").."/generating.lua")
--dofile(minetest.get_modpath("sas_core").."/nodes.lua")
--dofile(minetest.get_modpath("sas_core").."/crafting.lua")
...
minetest.register_alias("sas_core:twig",	"sas_core:twig_1")
...
for i in pairs(NoDe) do
	local NR = NoDe[i][1]
	local iNV = NR - 1
	minetest.register_node("sas_core:twig_"..NR, {
		description = "Twig",
		...
		on_place = function(itemstack, placer, pointed_thing)
			...
			if minetest.get_node(pt.above).name=="air" then
				minetest.set_node(pt.above, {name="sas_core:twig_"..math.random(1,4), param2=direction})
...
minetest.register_node("sas_core:moss", {
	description = "Moss",
...
-- MoSS & FuNGuS
-----------------------------------------------------------------------------------------------
minetest.register_node("sas_core:moss_fungus", {
...
-- TWiGS BLoCK
-----------------------------------------------------------------------------------------------
minetest.register_alias("woodstuff:twigs",	"sas_core:twigs")

minetest.register_node("sas_core:twigs", {
...
-- TWiGS SLaB
-----------------------------------------------------------------------------------------------
minetest.register_alias("woodstuff:twigs_slab",	"sas_core:twigs_slab")

minetest.register_node("sas_core:twigs_slab", {
...
-- TWiGS RooF
-----------------------------------------------------------------------------------------------
minetest.register_alias("woodstuff:twigs_roof",	"sas_core:twigs_roof")

minetest.register_node("sas_core:twigs_roof", {
...
-- TWiGS RooF CoRNeR
-----------------------------------------------------------------------------------------------
minetest.register_alias("woodstuff:twigs_roof_corner",	"sas_core:twigs_roof_corner")

minetest.register_node("sas_core:twigs_roof_corner", {
...
-- TWiGS RooF CoRNeR 2
-----------------------------------------------------------------------------------------------
minetest.register_alias("woodstuff:twigs_roof_corner_2",	"sas_core:twigs_roof_corner_2")

minetest.register_node("sas_core:twigs_roof_corner_2", {
...
if Auto_Roof_Corner == true then
	...
	local roof = "sas_core:twigs_roof"
	local corner = "sas_core:twigs_roof_corner"
	local corner_2 = "sas_core:twigs_roof_corner_2"
...
for i in pairs(TRuNKS) do
	...
	if minetest.get_modpath(MoD) ~= nil then
		...
		minetest.register_node("sas_core:"..TRuNK.."root", {
...
--[[front]]		MoD.."_"..TRuNK..".png"
			...
			--drop = "sas_core:twig_1", -- not sure about this yet
			sounds = default.node_sound_wood_defaults(),
		}) 
...
sas_core.place_twig = function(pos)
...
--	small twigs	
	if twig_size <= 16 then
		minetest.set_node(right_here, {name="sas_core:twig_"..math.random(1,4), param2=math.random(0,3)})
	end
-- 	big twigs
...
--	big twig 1		
	if twig_size == 17 then
		if not (minetest.registered_nodes[minetest.get_node({x=pos.x+1,y=pos.y,z=pos.z+1}).name].buildable_to
			...
			if minetest.registered_nodes[node_here.name].buildable_to then
				minetest.set_node(right_here, {name="sas_core:twig_5"})
			end
			if minetest.registered_nodes[node_n_e.name].buildable_to then
				minetest.set_node(north_east, {name="sas_core:twig_7"})
			end
			if minetest.registered_nodes[node_east.name].buildable_to then
				minetest.set_node(east, 	  {name="sas_core:twig_8"})
			end
		end
	elseif twig_size == 18 then
		if not (minetest.registered_nodes[minetest.get_node({x=pos.x+1,y=pos.y,z=pos.z-1}).name].buildable_to
			...
			if minetest.registered_nodes[node_here.name].buildable_to then
				minetest.set_node(right_here, {name="sas_core:twig_5", param2=1})
			end
			if minetest.registered_nodes[node_s_e.name].buildable_to then
				minetest.set_node(south_east, {name="sas_core:twig_7", param2=1})
			end
			if minetest.registered_nodes[node_south.name].buildable_to then
				minetest.set_node(south, 	  {name="sas_core:twig_8", param2=1})
			end
		end
	elseif twig_size == 19 then
		if not (minetest.registered_nodes[minetest.get_node({x=pos.x+1,y=pos.y,z=pos.z-1}).name].buildable_to
			...
			if minetest.registered_nodes[node_here.name].buildable_to then
				minetest.set_node(right_here, {name="sas_core:twig_5", param2=2})
			end
			if minetest.registered_nodes[node_s_w.name].buildable_to then
				minetest.set_node(south_west, {name="sas_core:twig_7", param2=2})
			end
			if minetest.registered_nodes[node_west.name].buildable_to then
				minetest.set_node(west, 	  {name="sas_core:twig_8", param2=2})
			end
		end
	elseif twig_size == 20 then
		if not (minetest.registered_nodes[minetest.get_node({x=pos.x-1,y=pos.y,z=pos.z+1}).name].buildable_to
			...
			if minetest.registered_nodes[node_here.name].buildable_to then
				minetest.set_node(right_here, {name="sas_core:twig_5", param2=3})
			end
			if minetest.registered_nodes[node_n_w.name].buildable_to then
				minetest.set_node(north_west, {name="sas_core:twig_7", param2=3})
			end
			if minetest.registered_nodes[node_north.name].buildable_to then
				minetest.set_node(north, 	  {name="sas_core:twig_8", param2=3})
			end
		end
--	big twig 2		
	elseif twig_size == 21 then
		if not (minetest.registered_nodes[minetest.get_node({x=pos.x,y=pos.y,z=pos.z+1}).name].buildable_to
			...
			if minetest.registered_nodes[node_here.name].buildable_to then
				minetest.set_node(right_here, {name="sas_core:twig_9"})
			end
			if minetest.registered_nodes[node_north.name].buildable_to then
				minetest.set_node(north, 	  {name="sas_core:twig_10"})
			end
			if minetest.registered_nodes[node_n_e.name].buildable_to then
				minetest.set_node(north_east, {name="sas_core:twig_11"})
			end
		end
	elseif twig_size == 22 then
		if not (minetest.registered_nodes[minetest.get_node({x=pos.x+1,y=pos.y,z=pos.z}).name].buildable_to
			...
			if minetest.registered_nodes[node_here.name].buildable_to then
				minetest.set_node(right_here, {name="sas_core:twig_9", param2=1})
			end
			if minetest.registered_nodes[node_east.name].buildable_to then
				minetest.set_node(east, 	  {name="sas_core:twig_10", param2=1})
			end
			if minetest.registered_nodes[node_s_e.name].buildable_to then
				minetest.set_node(south_east, {name="sas_core:twig_11", param2=1})
			end
		end
	elseif twig_size == 23 then
		if not (minetest.registered_nodes[minetest.get_node({x=pos.x,y=pos.y,z=pos.z-1}).name].buildable_to
			...
			if minetest.registered_nodes[node_here.name].buildable_to then
				minetest.set_node(right_here, {name="sas_core:twig_9", param2=2})
			end
			if minetest.registered_nodes[node_south.name].buildable_to then
				minetest.set_node(south, 	  {name="sas_core:twig_10", param2=2})
			end
			if minetest.registered_nodes[node_s_w.name].buildable_to then
				minetest.set_node(south_west, {name="sas_core:twig_11", param2=2})
			end
		end
	elseif twig_size == 24 then
		if not (minetest.registered_nodes[minetest.get_node({x=pos.x-1,y=pos.y,z=pos.z}).name].buildable_to
			...
			if minetest.registered_nodes[node_here.name].buildable_to then
				minetest.set_node(right_here, {name="sas_core:twig_9", param2=3})
			end
			if minetest.registered_nodes[node_west.name].buildable_to then
				minetest.set_node(west, 	  {name="sas_core:twig_10", param2=3})
			end
			if minetest.registered_nodes[node_n_w.name].buildable_to then
				minetest.set_node(north_west, {name="sas_core:twig_11", param2=3})
			end
		end
	elseif twig_size <= 25 then
		minetest.set_node(right_here, {name="sas_core:twig_"..math.random(12,13), param2=math.random(0,3)})
	end
	end
end
...
sas_core:register_generate_plant({
    ...
    min_elevation = 1,
	max_elevation = 40,
	near_nodes = {"group:tree","sas_core:fern_03","sas_core:fern_02","sas_core:fern_01"},
	near_nodes_size = 3,
...
sas_core.place_trunk = function(pos)
...
sas_core.grow_moss_on_ground = function(pos)
	local on_ground = {x=pos.x, y=pos.y+1, z=pos.z}
	local moss_type = math.random(1,21)
	
	if moss_type == 1 then
		minetest.set_node(on_ground, {name="sas_core:moss_fungus", param2=math.random(0,3)})
	else
		minetest.set_node(on_ground, {name="sas_core:moss", param2=math.random(0,3)})
	end
...
sas_core.grow_moss_on_trunk = function(pos)
	local on_ground = {x=pos.x, y=pos.y+1, z=pos.z}
	...
	--if minetest.get_item_group(node_under.name, "tree") < 1 then
		...
		if minetest.registered_nodes[node_here.name].buildable_to then -- instead of check_air = true,
			if moss_type == 1 then
				minetest.set_node(on_ground, {name="sas_core:moss_fungus", param2=math.random(0,3) --[[1]]})
			elseif moss_type < 22 then
				minetest.set_node(on_ground, {name="sas_core:moss", param2=math.random(0,3) --[[1]]})
			end
		end
		...
		if minetest.registered_nodes[node_north.name].buildable_to then -- instead of check_air = true,
			if moss_type == 1 then
				minetest.set_node(at_side_n, {name="sas_core:moss_fungus", param2=math.random(4,7)}) -- 5,4,6,7
			elseif moss_type < 22 then
				minetest.set_node(at_side_n, {name="sas_core:moss", param2=math.random(4,7)})
			end
		end
		local moss_type = math.random(1,41)
		if minetest.registered_nodes[node_east.name].buildable_to then -- instead of check_air = true,
			if moss_type == 1 then
				minetest.set_node(at_side_e, {name="sas_core:moss_fungus", param2=math.random(12,15)})
			elseif moss_type < 22 then
				minetest.set_node(at_side_e, {name="sas_core:moss", param2=math.random(12,15)})
			end
		end
		local moss_type = math.random(1,41)
		if minetest.registered_nodes[node_south.name].buildable_to then -- instead of check_air = true,
			if moss_type == 1 then
				minetest.set_node(at_side_s, {name="sas_core:moss_fungus", param2=math.random(8,11)})
			elseif moss_type < 22 then
				minetest.set_node(at_side_s, {name="sas_core:moss", param2=math.random(8,11)})
			end
		end
		local moss_type = math.random(1,41)
		if minetest.registered_nodes[node_west.name].buildable_to then -- instead of check_air = true,
			if moss_type == 1 then
				minetest.set_node(at_side_w, {name="sas_core:moss_fungus", param2=math.random(16,19)})
			elseif moss_type < 22 then
				minetest.set_node(at_side_w, {name="sas_core:moss", param2=math.random(16,19)})
			end
		end
	--end
end
...
sas_core.grow_roots = function(pos)
	local twig_size 	= math.random(1,27)
	...
	for i in pairs(TRuNKS) do
		...
		and node_here.param2 == 0 then
			if minetest.registered_nodes[node_north.name].buildable_to then
				minetest.set_node(north, {name="sas_core:"..TRuNK.."root", param2=2})
			end
			if minetest.registered_nodes[node_east.name].buildable_to then
				minetest.set_node(east, {name="sas_core:"..TRuNK.."root", param2=3})
			end
			if minetest.registered_nodes[node_south.name].buildable_to then
				minetest.set_node(south, {name="sas_core:"..TRuNK.."root", param2=0})
			end
			if minetest.registered_nodes[node_west.name].buildable_to then
				minetest.set_node(west, {name="sas_core:"..TRuNK.."root", param2=1})
			end
		end
	end
end
...
minetest.register_craft({ -- BushLeaves --> twigs
	output = "sas_core:twig_1 2",
	recipe = {{"sas_core:BushLeaves1"}}
})
minetest.register_craft({
	output = "sas_core:twig_1 2",
	recipe = {{"sas_core:BushLeaves2"}}
})
minetest.register_craft({ -- bushbranches --> twigs
	output = "sas_core:twig_1 4",
	recipe = {{"sas_core:bushbranches1"}}
})
minetest.register_craft({
	output = "sas_core:twig_1 4",
	recipe = {{"sas_core:bushbranches2"}}
})
minetest.register_craft({
	output = "sas_core:twig_1 4",
	recipe = {{"sas_core:bushbranches2a"}}
})
minetest.register_craft({
	output = "sas_core:twig_1 4",
	recipe = {{"sas_core:bushbranches3"}}
})
--end
minetest.register_craft({ -- twigs block --> twigs
	output = "sas_core:twig_1 8",
	recipe = {{"sas_core:twigs"}}
})
minetest.register_craft({ -- twigs_slab --> twigs
	output = "sas_core:twig_1 4",
	recipe = {{"sas_core:twigs_slab"}}
})
minetest.register_craft({ -- twigs_roof --> twigs
	output = "sas_core:twig_1 4",
	recipe = {{"sas_core:twigs_roof"}}
})
minetest.register_craft({ -- twigs_roof_corner --> twigs
	output = "sas_core:twig_1 3",
	recipe = {{"sas_core:twigs_roof_corner"}}
})
minetest.register_craft({ -- twigs_roof_corner_2 --> twigs
	output = "sas_core:twig_1 3",
	recipe = {{"sas_core:twigs_roof_corner_2"}}
})
-----------------------------------------------------------------------------------------------
-- STiCK
-----------------------------------------------------------------------------------------------
...
minetest.register_craft({ -- twigs --> twigs block
	output = "sas_core:twigs",
	recipe = {
		{"sas_core:twig_1","sas_core:twig_1","sas_core:twig_1"},
		{"sas_core:twig_1",      ""       ,"sas_core:twig_1"},
		{"sas_core:twig_1","sas_core:twig_1","sas_core:twig_1"},
	}
})
...
minetest.register_craft({ -- twigs blocks --> twigs_slabs
	output = "sas_core:twigs_slab 6",
	recipe = {
		{"sas_core:twigs","sas_core:twigs","sas_core:twigs"},
	}
})
...
minetest.register_craft({ -- twigs blocks --> twigs_roof_corners
	output = "sas_core:twigs_roof_corner 8",
	recipe = {
		{      ""      ,"sas_core:twigs",      ""      },
		{"sas_core:twigs",      ""      ,"sas_core:twigs"},
	}
})
...
minetest.register_craft({ -- twigs blocks --> twigs_roof_corner_2's
	output = "sas_core:twigs_roof_corner_2 8",
	recipe = {
		{"sas_core:twigs",      ""      ,"sas_core:twigs"},
		{      ""      ,"sas_core:twigs",      ""      },
	}
