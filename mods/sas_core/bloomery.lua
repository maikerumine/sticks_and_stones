...
minetest.register_alias("default:bloomery", "sas_core:bloomery")
minetest.register_alias("default:bloomery_active", "sas_core:bloomery_active")
...
local crushingfurnace_receipes = {
	--input                 output            time
	{"sas_core:iron_bloom_material", "sas_core:iron_bloom",      60},
	{"sas_core:iron_bloom", "default:steel_ingot",      60},
	{"bucket:bucket_empty", "default:steel_ingot 3",      60},
	{"default:steel_ingot", "sas_core:redhot_steel_ingot",      60},
	{"default:copper_lump", "sas_core:orangehot_copper_ingot",      60},
	{"default:copper_ingot", "sas_core:orangehot_copper_ingot",      60},
	{"default:sand", "vessels:glass_fragments",      3},
	{"default:desert_sand", "vessels:glass_fragments",      3},
	{"default:silver_sand", "vessels:glass_fragments",      3},
	{"default:sand", "vessels:glass_fragments",      3},
	{"vessels:glass_fragments", "default:glass",      3},
	...
	{"sas_core:tool_steel_mandrel", "sas_core:redhot_tool_steel_mandrel",      125},
	--{"sas_core:mold_hinge", "sas_core:redhot_mold_hinge",      7},
	--{"sas_core:mold_pick_head", "sas_core:redhot_mold_pick_head",      100},
	--{"sas_core:mold_axe_head", "sas_core:redhot_mold_axe_head",      75},
	--{"sas_core:mold_shovel_head", "sas_core:redhot_mold_shovel_head",      70},
	--{"sas_core:mold_sword_head", "sas_core:redhot_mold_sword_head",      65},
	{"sas_core:steel_bar", "sas_core:redhot_steel_bar",      15},
	{"sas_core:copper_bar", "sas_core:redhot_copper_bar",      7},
	{"sas_core:tool_steel_tongs", "sas_core:redhot_tool_steel_tongs",      35},
	{"sas_core:steel_battleaxe_head", "sas_core:redhot_steel_battleaxe_head",      65},
	{"sas_core:tool_anvil_hammer_head", "sas_core:redhot_tool_anvil_hammer_head",      65},
	--musket
	{"sas_core:steel_barrel_musket", "sas_core:redhot_steel_barrel_musket",      75},
	{"sas_core:steel_barrel_long", "sas_core:redhot_steel_barrel_long",      75},
	{"sas_core:steel_barrel_medium", "sas_core:redhot_steel_barrel_medium",      55},
	{"sas_core:steel_barrel_short", "sas_core:redhot_steel_barrel_short",      35},
	
	{"sas_core:tool_pick_iron", "sas_core:redhot_pick_head",      180},
	{"sas_core:tool_pick_steel", "sas_core:redhot_pick_head",      180},
	{"sas_core:tool_axe_iron", "sas_core:redhot_axe_head",      180},
	{"sas_core:tool_axe_steel", "sas_core:redhot_axe_head",      180},
	{"sas_core:tool_shovel_iron", "sas_core:redhot_shovel_head",      180},
	{"sas_core:tool_shovel_steel", "sas_core:redhot_shovel_head",      180},
	{"sas_core:tool_sword_iron", "sas_core:redhot_sword_head",      180},
	{"sas_core:tool_sword_steel", "sas_core:redhot_sword_head",      180},
	
	--stone cooking
	{"sas_core:basalt_cobble", "sas_core:basalt",      20},
	...
	{"sas_core:schist", "sas_core:gneiss",      20},
	{"sas_core:gneiss_cobble", "sas_core:gneiss",      20},
	{"sas_core:ors_cobble", "sas_core:ors",      20},
	{"default:sandstone", "sas_core:ors_cobble",      20},
	{"sas_core:slate", "sas_core:schist",      20},
	{"sas_core:mud", "sas_core:shale",      20},
	{"sas_core:shale", "sas_core:slate",      20},
	{"sas_core:slate_cobble", "sas_core:slate",      20},
	{"default:desert_stone", "sas_core:ors_cobble",      20},
	{"default:stone", "default:cobble",      20},
	
	--melting
	{"doors:trapdoor_steel", "sas_core:redhot_steel_ingot 4",      20},
	{"doors:door_steel", "sas_core:redhot_steel_ingot 6",      20},
	{"sas_core:iron_bars", "sas_core:redhot_steel_ingot 3",      20},
	{"sas_core:iron_grille", "sas_core:redhot_steel_ingot 12",      20},
	{"vessels:steel_bottle", "sas_core:redhot_steel_ingot 1",      20},
	{"doors:door_steel", "sas_core:redhot_steel_ingot 6",      20},
	{"doors:trapdoor_steel", "sas_core:redhot_steel_ingot 4",      20},
...
minetest.register_node("sas_core:bloomery", {
...
minetest.register_node("sas_core:bloomery_active", {
	tiles = {
...
minetest.register_abm({
	nodenames = {"sas_core:bloomery","sas_core:bloomery_active"},
	interval = 1.0,
	chance = 1,
	action = function(pos, node, active_object_count, active_object_count_wider)
		...
		if meta:get_float("fuel_time") < meta:get_float("fuel_totaltime") then
			...
			hacky_swap_node(pos,"sas_core:bloomery_active")
		...
		if fuel.time <= 0 then
			...
			hacky_swap_node(pos, "sas_core:bloomery")
			meta:set_string("formspec", furnace_inactive_formspec)
			return
		end
