...
sas_core.is_touching = is_touching
...
sas_core.is_water = is_water

local node_is_water = function(node)
	return (minetest.get_item_group(node.name, "water") ~= 0)
end

sas_core.node_is_water = node_is_water
...
sas_core.quick_flow = quick_flow
...
sas_core.move_centre = move_centre
