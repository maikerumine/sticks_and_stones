...
register_food("sas_core:fiddlehead", 1, "", 1)
register_food("sas_core:fiddlehead_roasted", 3)
register_food("sas_core:ferntuber_roasted", 3)
register_food("sas_core:horsetail_01", 1)
register_food("sas_core:fish_raw", 2)
register_food("sas_core:fish_cooked", 5)
register_food("sas_core:sushi", 6)
register_food("sas_core:shark", 4)
register_food("sas_core:shark_cooked", 8)
register_food("sas_core:pike", 4)
register_food("sas_core:pike_cooked", 8)
register_food("sas_core:sugar", 1)
register_food("sas_core:strawberry", 2)
register_food("sas_core:berry_pie_raw", 3)
register_food("sas_core:berry_pie_cooked", 4)
register_food("sas_core:basket_pies", 15)	
	...
	for _, berry in ipairs(berries) do
		if berry ~= "mixed_berry" then
			register_food("sas_core:"..berry, 1)
		end
		register_food("sas_core:"..berry.."_pie_raw", 2)
		register_food("sas_core:"..berry.."_pie_cooked", 5)
		register_food("sas_core:basket_"..berry, 15)
	end	
register_food("sas_core:kelpgreen", 1)
register_food("sas_core:kelpbrown", 1)
register_food("sas_core:seagrassgreen", 1)
register_food("sas_core:seagrassred", 1)
register_food("sas_core:seasaladmix", 6)
register_food("sas_core:kelpgreensalad", 1)
register_food("sas_core:kelpbrownsalad", 1)
register_food("sas_core:seagrassgreensalad", 1)
register_food("sas_core:seagrassgreensalad", 1)	
