...
dofile(minetest.get_modpath("sas_core").."/molehills_settings.txt")

-----------------------------------------------------------------------------------------------
-- NoDe
-----------------------------------------------------------------------------------------------
minetest.register_node("sas_core:molehill",{
	drawtype = "nodebox",
...
minetest.register_craft({ -- molehills --> dirt
	output = "default:dirt",
	recipe = {
		{"sas_core:molehill","sas_core:molehill"},
		{"sas_core:molehill","sas_core:molehill"},
	}
})
...
-- GeNeRaTiNG
-----------------------------------------------------------------------------------------------
sas_core.place_molehill = function(pos)
	...
	and minetest.get_node({x=pos.x-1, y=pos.y, z=pos.z-1}).name ~= "air" then
		minetest.set_node(right_here, {name="sas_core:molehill"})
	end
end
