...
minetest.register_alias("gravelsieve:sieved_gravel", "sas_core:sieved_gravel")
minetest.register_alias("gravelsieve:compressed_gravel", "sas_core:compressed_gravel")
minetest.register_alias("default:sieved_gravel", "sas_core:sieved_gravel")
minetest.register_alias("default:compressed_gravel", "sas_core:compressed_gravel")

minetest.register_alias("gravelsieve:hammer", "sas_core:tool_gravel_sieve_hammer")
minetest.register_alias("default:tool_gravel_sieve_hammer", "sas_core:tool_gravel_sieve_hammer")

minetest.register_alias("gravelsieve:auto_sieve0", "sas_core:auto_sieve0")
minetest.register_alias("gravelsieve:auto_sieve1", "sas_core:auto_sieve1")
minetest.register_alias("gravelsieve:auto_sieve2", "sas_core:auto_sieve2")
minetest.register_alias("gravelsieve:auto_sieve3", "sas_core:auto_sieve3")

minetest.register_alias("gravelsieve:sieve0", "sas_core:sieve0")
minetest.register_alias("gravelsieve:sieve1", "sas_core:sieve1")
minetest.register_alias("gravelsieve:sieve2", "sas_core:sieve2")
minetest.register_alias("gravelsieve:sieve3", "sas_core:sieve3")


minetest.register_alias("default:auto_sieve0", "sas_core:auto_sieve0")
minetest.register_alias("default:auto_sieve1", "sas_core:auto_sieve1")
minetest.register_alias("default:auto_sieve2", "sas_core:auto_sieve2")
minetest.register_alias("default:auto_sieve3", "sas_core:auto_sieve3")

minetest.register_alias("default:sieve0", "sas_core:sieve0")
minetest.register_alias("default:sieve1", "sas_core:sieve1")
minetest.register_alias("default:sieve2", "sas_core:sieve2")
minetest.register_alias("default:sieve3", "sas_core:sieve3")
...
--local ore_rarity =  1
sas_core.ore_rarity =  1


-- Ore probability table  (1/n)
--local ore_probability = {

sas_core.ore_probability = {
	["default:coal_lump"] = 115,
	["sas_core:copper_nugget"] = 30,
	["default:iron_lump"] = 55,
	["sas_core:charcoal_chips"] = 75,
	["default:clay_lump"] = 95,
	--["sas_core:copper_lump"] = 60,
	--["sas_core:tin_lump"] = 80,
	--["sas_core:gold_lump"] = 175,
	--["sas_core:mese_crystal"] = 275,
	--["sas_core:diamond"] = 340,
...
for ore, probability in pairs(sas_core.ore_probability) do
	if not minetest.registered_items[ore] then
		sas_core.ore_probability[ore] = nil
	end
end
...
local function random_ore(inv, src)
	...
	for ore, probability in pairs(sas_core.ore_probability) do
		...
		probability = probability * sas_core.ore_rarity
...
local function add_gravel_to_dst(meta, inv)
	...
	if (gravel_cnt % 2) == 0 then  -- gravel or sieved gravel?
		inv:add_item("dst", ItemStack("sas_core:gravel"))        -- add to dest
	else
		inv:add_item("dst", ItemStack("sas_core:sieved_gravel")) -- add to dest
	end
end
...
local function move_src2dst(meta, pos, inv, src, dst)
	if inv:room_for_item("dst", dst) and inv:contains_item("src", src) then
		...
		if res then                                     -- time to move one item?
			if src:get_name() == "sas_core:gravel" then  -- will we find ore?
...
local function sieve_node_timer(pos, elapsed)
	...
	local gravel_sieved = ItemStack("sas_core:sieved_gravel")
...
------------------------------------------------------------------------
if tubelib then
	tubelib.register_node("sas_core:auto_sieve3", 
		{
			"sas_core:auto_sieve0",
			"sas_core:auto_sieve1",
			"sas_core:auto_sieve2",
		},
		{
...
minetest.register_node("sas_core:sieved_gravel", {
...
minetest.register_node("sas_core:compressed_gravel", {
...
sas_core.disallow = function(pos, node, user, mode, new_param2)
	return false
end
...
default.handler = function(itemstack, user, pointed_thing)
	...
	if node.name == "default:cobble" or node.name == "default:mossycobble" 
			or node.name == "sasdefault_core:desert_cobble" then
...
minetest.register_tool("sas_core:tool_gravel_sieve_hammer", {
...
minetest.register_craft({
	output = "sas_core:tool_gravel_sieve_hammer",
	recipe = {
		{"", "sas_core:steel_ingot", ""},
		{"", "sas_core:cord", "sas_core:steel_ingot"},
		{"sas_core:handle_medium", "sas_core:glue", ""},
	}
})
]]
minetest.register_craft({
	...
	recipe = {
		{"", "", ""},
		{"", "sas_core:gravelsieve_hammer_head", ""},
		{"sas_core:cord", "sas_core:handle_medium", "sas_core:glue"},
	}
})

minetest.register_craft({
	output = "sas_core:sieve3",
	recipe = {
		{"sas_core:iron_hardware", "",                      "sas_core:iron_hardware"},
		{"sas_core:glue", "sas_core:iron_grille",   "sas_core:glue"},
		{"group:wood", "",                      "group:wood"},
	},
})
--[[
minetest.register_craft({
	output = "sas_core:auto_sieve3",
	recipe = {
		{"sas_core:sieve3", "sas_core:iron_hardware",  "sas_core:copperblock"},
	},
})
]]
minetest.register_craft({
	output = "sas_core:compressed_gravel",
	recipe = {
		{"sas_core:sieved_gravel", "sas_core:sieved_gravel"},
		{"sas_core:sieved_gravel", "sas_core:sieved_gravel"},
	},
})
...
minetest.register_craft({
	...
	recipe = "sas_core:compressed_gravel",
	cooktime = 10,
})
