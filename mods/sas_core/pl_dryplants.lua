...
local function sickle_on_use(itemstack, user, pointed_thing, uses)
	...
	if minetest.get_item_group(under.name, "snappy") > 0 then
		...
		if minetest.get_item_group(under.name, "flora") == 1 and minetest.get_item_group(under.name, "flower") == 0 then
			...
			minetest.set_node(pt.under, {name="sas_core:grass"})
	...
	elseif string.find(under.name, "default:dirt_with_grass") then
		...
		minetest.set_node(pt.under, {name="sas_core:grass_short"})
		minetest.set_node(above_pos, {name="sas_core:grass"})
		minetest.sound_play("default_dig_crumbly", {
			pos = pt.under,
			gain = 0.5,
		})
...
-- the tool
minetest.register_tool("sas_core:sickle", {
...
-- Cut Grass
-----------------------------------------------------------------------------------------------
minetest.register_node("sas_core:grass", {
...
-- Hay
-----------------------------------------------------------------------------------------------
minetest.register_node("sas_core:hay", {
	description = "Hay",
...
-- Short Grass
-----------------------------------------------------------------------------------------------
minetest.register_node("sas_core:grass_short", {
...
-----------------------------------------------------------------------------------------------
minetest.register_abm({
	nodenames = {"sas_core:grass_short"},
	...
	action = function(pos)
		...
		if above.name ~= "sas_core:grass" and above.name ~= "sas_core:hay" then
...
if minetest.get_modpath("flint") ~= nil then
	minetest.register_craft({
		output = "sas_core:sickle",
		recipe = {
			{"flint:flintstone","sas_core:glue"},
			{"", "default:stick"},
			{"sas_core:handle_short",""}
		}
	})
end
...
minetest.register_craft({ -- reedmace_sapling -> wetreed
	output = "sas_core:wetreed 2",
	recipe = {
		{"sas_core:reedmace_sapling","sas_core:reedmace_sapling"},
		{"sas_core:reedmace_sapling","sas_core:reedmace_sapling"},
	}
})
minetest.register_craft({ -- reedmace_top -> wetreed
	output = "sas_core:wetreed 2",
	recipe = {
		{"sas_core:reedmace_top","sas_core:reedmace_top"},
		{"sas_core:reedmace_top","sas_core:reedmace_top"},
	}
})
minetest.register_craft({ -- reedmace -> wetreed
	output = "sas_core:wetreed 2",
	recipe = {
		{"sas_core:reedmace","sas_core:reedmace"},
		{"sas_core:reedmace","sas_core:reedmace"},
	}
})
minetest.register_craft({ -- reedmace_bottom -> wetreed
	output = "sas_core:wetreed 2",
	recipe = {
		{"sas_core:reedmace_bottom","sas_core:reedmace_bottom"},
		{"sas_core:reedmace_bottom","sas_core:reedmace_bottom"},
	}
})
...
minetest.register_craft({ -- hay -> reed
	output = "sas_core:reed 2",
	recipe = {
		{"sas_core:hay","sas_core:hay"},
		{"sas_core:hay","sas_core:hay"},
	}
})
--cooking
minetest.register_craft({ -- wetreed -> reed
	type = "cooking",
	output = "sas_core:reed",
	recipe = "sas_core:wetreed",
	cooktime = 2,
})
--fuel
minetest.register_craft({
	type = "fuel",
	recipe = "sas_core:reed",
	burntime = 4,
})
-----------------------------------------------------------------------------------------------
-- Reed Slab
...
minetest.register_craft({ -- wetreed_slab -> reed_slab
	type = "cooking",
	output = "sas_core:reed_slab",
	recipe = "sas_core:wetreed_slab",
	cooktime = 1,
})
--fuel
minetest.register_craft({
	type = "fuel",
	recipe = "sas_core:reed_slab",
	burntime = 2,
})
-----------------------------------------------------------------------------------------------
-- Reed Roof
...
minetest.register_craft({ -- wetreed_roof -> reed_roof
	type = "cooking",
	output = "sas_core:reed_roof",
	recipe = "sas_core:wetreed_roof",
	cooktime = 1,
})
--fuel
minetest.register_craft({
	type = "fuel",
	recipe = "sas_core:reed_roof",
	burntime = 2,
})
-----------------------------------------------------------------------------------------------
-- Reed Roof Corner
...
minetest.register_craft({ -- wetreed_roof_corner -> reed_roof_corner
	type = "cooking",
	output = "sas_core:reed_roof_corner",
	recipe = "sas_core:wetreed_roof_corner",
	cooktime = 1,
})
--fuel
minetest.register_craft({
	type = "fuel",
	recipe = "sas_core:reed_roof_corner",
	burntime = 2,
})
-----------------------------------------------------------------------------------------------
...
minetest.register_craft({ -- wetreed_roof_corner -> reed_roof_corner
	type = "cooking",
	output = "sas_core:reed_roof_corner_2",
	recipe = "sas_core:wetreed_roof_corner_2",
	cooktime = 1,
})
--fuel
minetest.register_craft({
	type = "fuel",
	recipe = "sas_core:reed_roof_corner_2",
	burntime = 2,
})
-----------------------------------------------------------------------------------------------
-- Dandelion Leave 
-----------------------------------------------------------------------------------------------
minetest.register_craftitem("sas_core:dandelion_leave", {
...
minetest.register_craft({
	type = "shapeless",
	output = "sas_core:dandelion_leave 4",
...
sas_core.grow_juncus = function(pos)
	local juncus_type = math.random(2,3)
	local right_here = {x=pos.x, y=pos.y+1, z=pos.z}
	if minetest.get_node(right_here).name == "air"  -- instead of check_air = true,
	or minetest.get_node(right_here).name == "default:junglegrass" then
		if juncus_type == 2 then
			minetest.set_node(right_here, {name="sas_core:juncus_02"})
		else
			minetest.set_node(right_here, {name="sas_core:juncus"})
		end
	end
end

minetest.register_node("sas_core:juncus", {
	description = "Juncus",
	drawtype = "plantlike",
	visual_scale = 2,
	paramtype = "light",
...
minetest.register_node("sas_core:juncus_02", {
	description = "Juncus",
	drawtype = "plantlike",
	visual_scale = 2,
	paramtype = "light",
...
sas_core.grow_grass_variation = function(pos)
	local right_here = {x=pos.x, y=pos.y, z=pos.z}
	minetest.set_node(right_here, {name="sas_core:grass_short"})
end
...
sas_core.grow_grass = function(pos)
	local right_here = {x=pos.x, y=pos.y+1, z=pos.z}
...
-----------------------------------------------------------------------------------------------
minetest.register_alias("stairs:stair_wetreed",				"sas_core:wetreed_roof")
minetest.register_alias("stairs:slab_wetreed",				"sas_core:wetreed_slab")
minetest.register_alias("stairs:stair_reed",				"sas_core:reed_roof")
minetest.register_alias("stairs:slab_reed",					"sas_core:reed_slab")


-----------------------------------------------------------------------------------------------
-- Wet Reed
-----------------------------------------------------------------------------------------------
minetest.register_node("sas_core:wetreed", {
...
-- Wet Reed Slab
-----------------------------------------------------------------------------------------------
minetest.register_node("sas_core:wetreed_slab", {
...
-- Wet Reed Roof
-----------------------------------------------------------------------------------------------
minetest.register_node("sas_core:wetreed_roof", {
...
--		  MaTeRiaL
	...
	for i in pairs(CoRNeR) do
		...
		local roof = "sas_core:"..MaTeRiaL.."_roof"
		local corner = "sas_core:"..MaTeRiaL.."_roof_corner"
		local corner_2 = "sas_core:"..MaTeRiaL.."_roof_corner_2"
...
-----------------------------------------------------------------------------------------------
minetest.register_node("sas_core:wetreed_roof_corner", {
...
-- Wet Reed Roof Corner 2
-----------------------------------------------------------------------------------------------
minetest.register_node("sas_core:wetreed_roof_corner_2", {
...
if REED_WILL_DRY == true then
	...
	local DRyiNG = {
--	  	  WeT									 DRy
		{"sas_core:wetreed",					"sas_core:reed"},
		{"sas_core:wetreed_slab",				"sas_core:reed_slab"},
		{"sas_core:wetreed_roof",				"sas_core:reed_roof"},
		{"sas_core:wetreed_roof_corner",		"sas_core:reed_roof_corner"},
		{"sas_core:wetreed_roof_corner_2",		"sas_core:reed_roof_corner_2"}
	}
...
-- Reed
-----------------------------------------------------------------------------------------------
minetest.register_node("sas_core:reed", {
	description = "Reed",
	paramtype = "light",
	paramtype2 = "facedir",
...
-- Reed Slab
-----------------------------------------------------------------------------------------------
minetest.register_node("sas_core:reed_slab", {
...
-- Reed Roof
-----------------------------------------------------------------------------------------------
minetest.register_node("sas_core:reed_roof", {
...
-- Reed Roof Corner
-----------------------------------------------------------------------------------------------
minetest.register_node("sas_core:reed_roof_corner", {
...
-- Reed Roof Corner 2
-----------------------------------------------------------------------------------------------
minetest.register_node("sas_core:reed_roof_corner_2", {
...
sas_core.grow_reedmace = function(pos)
	...
	or minetest.get_node(pos_01).name == "sas_core:reedmace_sapling" then
		if minetest.get_node(pos_02).name ~= "air" then
			minetest.set_node(pos_01, {name="sas_core:reedmace_top"})
		elseif minetest.get_node(pos_03).name ~= "air" then
			minetest.set_node(pos_01, {name="sas_core:reedmace_height_2"})
		elseif size == 1 then
			minetest.set_node(pos_01, {name="sas_core:reedmace_top"})
		elseif size == 2 then
			minetest.set_node(pos_01, {name="sas_core:reedmace_height_2"})
		elseif size == 3 then
			if spikes == 1 then
				minetest.set_node(pos_01, {name="sas_core:reedmace_height_3_spikes"})
			else
				minetest.set_node(pos_01, {name="sas_core:reedmace_height_3"})
			end
		end
	end
end

sas_core.grow_reedmace_water = function(pos)
	local size = math.random(1,3)
	local spikes = math.random(1,3)
	local pos_01 = {x = pos.x, y = pos.y + 1, z = pos.z}
	local pos_02 = {x = pos.x, y = pos.y + 2, z = pos.z}
	...
	minetest.add_entity(pos_01, "sas_core:reedmace_water_entity")
	if minetest.get_node(pos_02).name == "air" then -- bug fix
		if minetest.get_node(pos_03).name ~= "air" then
			minetest.set_node(pos_02, {name="sas_core:reedmace_top"})
		elseif minetest.get_node(pos_04).name ~= "air" then
			minetest.set_node(pos_02, {name="sas_core:reedmace_height_2"})
		elseif size == 1 then
			minetest.set_node(pos_02, {name="sas_core:reedmace_top"})
		elseif size == 2 then
			minetest.set_node(pos_02, {name="sas_core:reedmace_height_2"})
		elseif size == 3 then
			if spikes == 1 then
				minetest.set_node(pos_02, {name="sas_core:reedmace_height_3_spikes"})
			else
				minetest.set_node(pos_02, {name="sas_core:reedmace_height_3"})
			end	
		end
	end
end
...
-- REEDMACE SPIKES
-----------------------------------------------------------------------------------------------
minetest.register_node("sas_core:reedmace_spikes", {
	...
	drop = 'sas_core:reedmace_sapling',
	sounds = default.node_sound_leaves_defaults(),
	selection_box = {
		type = "fixed",
...
-- REEDMACE height: 1
-----------------------------------------------------------------------------------------------
minetest.register_node("sas_core:reedmace_top", {
...
-- REEDMACE height: 2
-----------------------------------------------------------------------------------------------
minetest.register_node("sas_core:reedmace_height_2", {
...
-- REEDMACE height: 3
-----------------------------------------------------------------------------------------------
minetest.register_node("sas_core:reedmace_height_3", {
...
-----------------------------------------------------------------------------------------------
minetest.register_node("sas_core:reedmace_height_3_spikes", {
...
-- REEDMACE STEMS
-----------------------------------------------------------------------------------------------
minetest.register_node("sas_core:reedmace", {
	description = "Reedmace",
	drawtype = "plantlike",
	paramtype = "light",
	...
	after_destruct = function(pos,oldnode)
        ...
        if node.name == "sas_core:reedmace_top"
		or node.name == "sas_core:reedmace_spikes" then 
            minetest.dig_node({x=pos.x,y=pos.y+1,z=pos.z}) 
            minetest.add_item(pos,"sas_core:reedmace_sapling")
        end
    end,
})
-----------------------------------------------------------------------------------------------
-- REEDMACE BOTTOM
-----------------------------------------------------------------------------------------------
minetest.register_node("sas_core:reedmace_bottom", {
	description = "Reedmace",
	drawtype = "plantlike",
	paramtype = "light",
	...
	after_destruct = function(pos,oldnode)
        local node = minetest.get_node({x=pos.x,y=pos.y+1,z=pos.z})
        if node.name == "sas_core:reedmace" 
		or node.name == "sas_core:reedmace_top"
		or node.name == "sas_core:reedmace_spikes" then 
            minetest.dig_node({x=pos.x,y=pos.y+1,z=pos.z}) 
            minetest.add_item(pos,"sas_core:reedmace_sapling")
        end
...
-----------------------------------------------------------------------------------------------
minetest.register_node("sas_core:reedmace_sapling", {
	description = "Reedmace",
	drawtype = "plantlike",
	paramtype = "light",
...
-- abm
minetest.register_abm({
	nodenames = "sas_core:reedmace_sapling",
	...
	action = function(pos, node, _, _)
		...
		or string.find(minetest.get_node({x = pos.x, 	 y = pos.y, z = pos.z - 1}).name, "default:water") then
			if minetest.get_node({x = pos.x, y = pos.y + 1, z = pos.z}).name == "air" then
				sas_core.grow_reedmace_water({x = pos.x, y = pos.y - 1, z = pos.z})
			end
			minetest.set_node({x=pos.x, y=pos.y, z=pos.z}, {name="default:water_source"})
		else
			sas_core.grow_reedmace({x = pos.x, y = pos.y - 1, z = pos.z})
		end
    end
})
-----------------------------------------------------------------------------------------------
...
-----------------------------------------------------------------------------------------------
minetest.register_node("sas_core:reedmace_water", {
	description = "Reedmace",
	drawtype = "plantlike",
	paramtype = "light",
...
-----------------------------------------------------------------------------------------------
minetest.register_entity("sas_core:reedmace_water_entity",{
	visual = "mesh",
	mesh = "plantlike.obj",
	...
	on_punch = function(self, puncher)
		if puncher:is_player() and puncher:get_inventory() then
			if not minetest.setting_getbool("creative_mode") then
				puncher:get_inventory():add_item("main", "sas_core:reedmace_sapling")
			end
			self.object:remove()
		end
	end,
...
--[[sas_core:spawn_on_surfaces({
	spawn_delay = 1200,
	spawn_plants = {"sas_core:reedmace_sapling"},
	spawn_chance = 400,
	spawn_surfaces = {
