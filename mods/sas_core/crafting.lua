...
minetest.register_craft({
	output = 'sas_core:charcoal_block 1',
	recipe = {
		{'sas_core:charcoal', 'sas_core:charcoal', 'sas_core:charcoal'},
		{'sas_core:charcoal', 'sas_core:charcoal', 'sas_core:charcoal'},
		{'sas_core:charcoal', 'sas_core:charcoal', 'sas_core:charcoal'},
	}
})
...
minetest.register_craft({
	output = 'sas_core:charcoal_chips 3',
	recipe = {
		{'sas_core:charcoal'}
	}
})
...
minetest.register_craft({
	output = 'sas_core:charcoal 9',
	recipe = {
		{'sas_core:charcoal_block'}
	}
})
