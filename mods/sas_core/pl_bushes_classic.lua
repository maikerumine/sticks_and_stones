...
-- blueberries
minetest.register_craftitem("sas_core:blueberry", {
...
minetest.register_craftitem("sas_core:blackberry", {
...
minetest.register_craftitem("sas_core:raspberry", {
...
minetest.register_craftitem("sas_core:strawberry", {
...
minetest.register_craftitem("sas_core:gooseberry", {
...
sas_core:spawn_on_surfaces({
	spawn_delay = 600,
	spawn_plants = sas_core.spawn_list,
	avoid_radius = 10,
	spawn_chance = 100,
	spawn_surfaces = {
		"default:dirt_with_grass",
		"sas_core:dirt_with_leaves_1",
		"sas_core:grass_with_leaves_1",
		"sas_core:grass_with_leaves_2",
		"farming:soil",
		"farming:soil_wet",
...
-- Sugar
--[[
minetest.register_craftitem(":sas_core:sugar", {
    description = S("Sugar"),
...
minetest.register_craft({
    output = "sas_core:sugar 1",
    recipe = {
	{ "sas_core:papyrus", "sas_core:papyrus" },
    },
})
]]
for i, berry in ipairs(sas_core.bushes) do
	local desc = sas_core.bushes_descriptions[i]

	minetest.register_craftitem("sas_core:"..berry.."_pie_raw", {
	...
	minetest.register_craft({
		output = "sas_core:"..berry.."_pie_raw 1",
		recipe = {
		{ "sas_core:sugar", "farming:flour", "sas_core:sugar" },
...
--	end
	...
	minetest.register_craftitem("sas_core:"..berry.."_pie_cooked", {
	...
	minetest.register_craft({
		type = "cooking",
		output = "sas_core:"..berry.."_pie_cooked",
		recipe = "sas_core:"..berry.."_pie_raw",
		cooktime = 30,
	})

	-- slice of pie

	minetest.register_craftitem("sas_core:"..berry.."_pie_slice", {
	...
	minetest.register_craft({
		output = "sas_core:"..berry.."_pie_slice 6",
		recipe = {
		{ "sas_core:"..berry.."_pie_cooked" },
		},
	})
	...
	minetest.register_craft({
		output = "sas_core:basket_"..berry.." 1",
		recipe = {
		{ "sas_core:"..berry.."_pie_cooked", "sas_core:"..berry.."_pie_cooked", "sas_core:"..berry.."_pie_cooked" },
		{ "", "sas_core:basket_empty", "" },
		},
	})
end

minetest.register_craft({
	output = "sas_core:mixed_berry_pie_raw 2",
	recipe = {
	{ "sas_core:sugar", "farming:flour", "sas_core:sugar" },
	{ "group:berry", "group:berry", "group:berry" },
	{ "group:berry", "group:berry", "group:berry" },
...
plantlife_bushes.after_dig_node = function(pos, oldnode, oldmetadata, digger)
	...
	if oldnode.name == "sas_core:fruitless_bush" then
	...
	elseif groupcaps.snappy then
		...
		minetest.set_node(pos, {type = "node", name = "sas_core:fruitless_bush"})
		...
		if can_harvest then
			...
			harvested = "sas_core:" .. bush_name .. " " .. amount
		end
	...
	elseif groupcaps.crumbly then
		...
		harvested = "sas_core:" .. bush_name .. "_bush "..amount
...
plantlife_bushes.after_place_node = function(pos, placer, itemstack)
	...
	minetest.set_node(pos, {name = "sas_core:fruitless_bush"})
	local meta = minetest.get_meta(pos)
...
minetest.register_abm({
	nodenames = {"sas_core:fruitless_bush"},
		...
		--if mymonths.month_counter == 6 or mymonths.month_counter == 7 or mymonths.month_counter == 8 then
			...
			if bush_name and bush_name ~= "" then
				...
				if is_soil and (dirt.name == "farming:soil_wet" or math.random(1,3) == 1) then
					minetest.set_node( pos, {name = "sas_core:" .. bush_name .. "_bush"})
				end
			end
		--end
		--]]
...
for i, bush_name in ipairs(sas_core.bushes) do

	local desc = sas_core.bushes_descriptions[i]

	minetest.register_node("sas_core:basket_"..bush_name, {
	...
	minetest.register_node("sas_core:" .. bush_name .. "_bush", {
	...
	if bush_name ~= "fruitless" then
		table.insert(sas_core.spawn_list, "sas_core:"..bush_name.."_bush")
	end
end

minetest.register_node("sas_core:basket_empty", {
