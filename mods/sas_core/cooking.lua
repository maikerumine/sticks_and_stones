...
-- Cooking recipes
--
--ONLY FOR CRAFT GUIDE NOT ACTUAL FURNACE
minetest.register_craft({
	type = 'cooking',
	recipe = 'group:tree',
	output = 'sas_core:charcoal',
	cooktime = 10,
})
minetest.register_craft({
	type = 'cooking',
	recipe = 'sas_core:crucible_glue',
	output = 'sas_core:glue',
	cooktime = 20,
})
minetest.register_craft({
	type = 'cooking',
	recipe = 'default:stick',
	output = 'sas_core:charcoal_chips',
	cooktime = 5,
})
minetest.register_craft({
	type = 'cooking',
	recipe = 'group:kindling',
	output = 'sas_core:charcoal_chips',
	cooktime = 5,
})
...
minetest.register_craft({
	type = "cooking",
	output = "sas_core:clay_brick",
	recipe = "sas_core:clay_lump",
	cooktime = 35,
})
...
minetest.register_craft({
	type = "cooking",
	output = "sas_core:stone",
	recipe = "sas_core:cobble",
	cooktime = 15,
})
...
minetest.register_craft({
	type = "cooking",
	output = "sas_core:stone",
	recipe = "sas_core:mossycobble",
	cooktime = 15,
})

minetest.register_craft({
	type = "cooking",
	output = "sas_core:desert_stone",
	recipe = "sas_core:desert_cobble",
	cooktime = 15,
})
...
minetest.register_craft({
	type = 'fuel',
	recipe = 'sas_core:charcoal',
	burntime = 35,
})

minetest.register_craft({
	type = 'fuel',
	recipe = 'sas_core:charcoal_block',
	burntime = 315,
})

-- Support use of group:plant_fiber
minetest.register_craft({
	type = "fuel",
	recipe = "group:plant_fiber",
	burntime = 1,
})

-- Support use of group:kindling
minetest.register_craft({
	type = "fuel",
	recipe = "group:kindling",
	burntime = 3,
