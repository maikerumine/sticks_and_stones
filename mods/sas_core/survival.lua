...
minetest.register_alias("survival:machete_steel", "sas_core:tool_machete_steel")
minetest.register_alias("survival:sleeping_bag", "sas_core:bed_sleeping_bag")
minetest.register_alias("survival:leafy_bed", "sas_core:bed_leafy_bed")
minetest.register_alias("survival:energy_bar", "sas_core:food_energy_bar")
minetest.register_alias("survival:spigot", "sas_core:spigot")
minetest.register_alias("survival:raw_kabob", "sas_core:raw_kabob")
minetest.register_alias("survival:cooked_kabob", "sas_core:food_cooked_kabob")
minetest.register_alias("survival:slug_cooked", "sas_core:slug_cooked")
minetest.register_alias("survival:slug_raw", "sas_core:slug_raw")
minetest.register_alias("survival:cricket_cooked", "sas_core:food_cricket_cooked")
minetest.register_alias("survival:cricket_raw", "sas_core:cricket_raw")
minetest.register_alias("survival:worm_cooked", "sas_core:food_worm_cooked")
minetest.register_alias("survival:worm_raw", "sas_core:worm_raw")
minetest.register_alias("survival:centipede_cooked", "sas_core:food_centipede_cooked")
minetest.register_alias("survival:centipede_raw", "sas_core:centipede_raw")
minetest.register_alias("survival:milipede_cooked", "sas_core:food_milipede_cooked")
minetest.register_alias("survival:milipede_raw", "sas_core:milipede_raw")
minetest.register_alias("survival:oyster_cooked", "sas_core:food_oyster_cooked")
minetest.register_alias("survival:oyster_raw", "sas_core:oyster_raw")
minetest.register_alias("survival:mussel_cooked", "sas_core:food_mussel_cooked")
minetest.register_alias("survival:mussel_raw", "sas_core:mussel_raw")
minetest.register_alias("survival:sugar", "sas_core:sugar")

minetest.register_alias("default:bucket_sap", "bucket:bucket_sap")
minetest.register_alias("sas_core:bucket_sap", "bucket:bucket_sap")
minetest.register_alias("bucket:bucket_sap", "bucket:bucket_sap")
minetest.register_alias("default:bucket_sap_cooked", "bucket:bucket_sap_cooked")
minetest.register_alias("sas_core:bucket_sap_cooked", "bucket:bucket_sap_cooked")
minetest.register_alias("bucket:bucket_sap_cooked", "bucket:bucket_sap_cooked")

minetest.register_alias("survival:raw_kabob", "sas_core:raw_kabob")
minetest.register_alias("survival:shell", "sas_core:shell")
minetest.register_alias("survival:nesting", "sas_core:nesting")
minetest.register_alias("survival:sand_with_food", "sas_core:sand_with_food")


minetest.register_alias("default:tool_machete_steel", "sas_core:tool_machete_steel")
minetest.register_alias("default:bed_sleeping_bag", "sas_core:bed_sleeping_bag")
minetest.register_alias("default:bed_leafy_bed", "sas_core:bed_leafy_bed")

minetest.register_alias("default:bed_sleeping_bag", "beds:bed_sleeping_bag")
minetest.register_alias("default:bed_leafy_bed", "beds:bed_leafy_bed")


minetest.register_alias("default:food_energy_bar", "sas_core:food_energy_bar")
minetest.register_alias("default:spigot", "sas_core:spigot")
minetest.register_alias("default:raw_kabob", "sas_core:raw_kabob")
minetest.register_alias("default:food_cooked_kabob", "sas_core:food_cooked_kabob")
minetest.register_alias("default:slug_cooked", "sas_core:slug_cooked")
minetest.register_alias("default:slug_raw", "sas_core:slug_raw")
minetest.register_alias("default:food_cricket_cooked", "sas_core:food_cricket_cooked")
minetest.register_alias("default:cricket_raw", "sas_core:cricket_raw")
minetest.register_alias("default:food_worm_cooked", "sas_core:food_worm_cooked")
minetest.register_alias("default:worm_raw", "sas_core:worm_raw")
minetest.register_alias("default:food_centipede_cooked", "sas_core:food_centipede_cooked")
minetest.register_alias("default:centipede_raw", "sas_core:centipede_raw")
minetest.register_alias("default:food_milipede_cooked", "sas_core:food_milipede_cooked")
minetest.register_alias("default:milipede_raw", "sas_core:milipede_raw")
minetest.register_alias("default:food_oyster_cooked", "sas_core:food_oyster_cooked")
minetest.register_alias("default:oyster_raw", "sas_core:oyster_raw")
minetest.register_alias("default:food_mussel_cooked", "sas_core:food_mussel_cooked")
minetest.register_alias("default:mussel_raw", "sas_core:mussel_raw")
minetest.register_alias("default:sugar", "sas_core:sugar")
minetest.register_alias("default:raw_kabob", "sas_core:raw_kabob")
minetest.register_alias("default:shell", "sas_core:shell")
minetest.register_alias("default:nesting", "sas_core:nesting")
minetest.register_alias("default:sand_with_food", "sas_core:sand_with_food")

--[[
minetest.register_abm({
   label = 'sand with food',
	nodenames = {"sas_core:sand"},
	neighbors = {"group:water"},
	interval = 30,
	chance = 75,
	action = function(pos, node)
		local name = minetest.get_node(pos).name
		if name == "sas_core:sand" then
...
minetest.register_craft({
		output = 'sas_core:tool_machete_steel 1',
		recipe = {
			{'', 'sas_core:cord', 'default:steel_ingot'},
			{'sas_core:glue', 'default:steel_ingot', 'sas_core:cord'},
			{'group:stick', 'sas_core:glue', ''},
		}
})

minetest.register_craft({
		output = 'beds:bed_sleeping_bag 1',
		recipe = {
		{'sas_core:cord', 'sas_core:cord', 'sas_core:cord'},
		{'sas_core:fabric', 'sas_core:fabric', 'sas_core:fabric'}
		},
})

minetest.register_craft({
		output = 'beds:bed_leafy_bed 1',
		recipe = {
...
minetest.register_craft({
		output = 'sas_core:food_energy_bar 1',
		recipe = {
		{'default:apple', 'default:apple', 'default:apple'},
		{'sas_core:sugar', 'mobs:honey', 'sas_core:sugar'},
		{'farming:seed_wheat', 'farming:seed_wheat', 'farming:seed_wheat'},
		}
})

minetest.register_craft({
		output = 'sas_core:spigot 1',
		recipe = {
		{'default:clay', '', ''},
...
minetest.register_craft({
		output = 'sas_core:raw_kabob 1',
		recipe = {
		{'sas_core:mussel_raw', 'sas_core:mussel_raw', 'sas_core:mussel_raw'},
		{'sas_core:oyster_raw', 'sas_core:oyster_raw', 'sas_core:oyster_raw'},
		{'group:stick', '', ''},
		}
})
...
minetest.register_craft({
		type = 'cooking',
		output = 'sas_core:food_slug_cooked',
		recipe = 'sas_core:slug_raw',
		cooktime = 1,
		})
		
minetest.register_craft({
		type = 'cooking',
		output = 'sas_core:food_cricket_cooked',
		recipe = 'sas_core:cricket_raw',
		cooktime = 1,
		})

minetest.register_craft({
		type = 'cooking',
		output = 'sas_core:food_worm_cooked',
		recipe = 'sas_core:worm_raw',
		cooktime = 1,
		})

minetest.register_craft({
		type = 'cooking',
		output = 'sas_core:food_centipede_cooked',
		recipe = 'sas_core:centipede_raw',
		cooktime = 1,
		})

minetest.register_craft({
		type = 'cooking',
		output = 'sas_core:food_milipede_cooked',
		recipe = 'sas_core:milipede_raw',
		cooktime = 1,
		})

minetest.register_craft({
		type = 'cooking',
		output = 'sas_core:food_oyster_cooked',
		recipe = 'sas_core:oyster_raw',
		cooktime = 3,
		replacements = {{'sas_core:oyster_raw', 'sas_core:shell'}},
})

minetest.register_craft({
		type = 'cooking',
		output = 'sas_core:food_mussel_cooked',
		recipe = 'sas_core:mussel_raw',
		cooktime = 3,
		replacements = {{'sas_core:mussel_raw', 'sas_core:shell'}},
})

minetest.register_craft({
		type = 'cooking',
		output = 'sas_core:sugar 4',
		recipe = 'bucket:bucket_sap',
		cooktime = 30,
		replacements = {{'bucket:bucket_sap', 'bucket:bucket_empty'}},
})

minetest.register_craft({
		type = 'cooking',
		output = 'sas_core:food_cooked_kabob',
		recipe = 'sas_core:raw_kabob',
		cooktime = 7,
})


minetest.register_craftitem('sas_core:shell', {
...
minetest.register_craft({
	output = 'sas_core:sugar 4',
	replacements = {{'sas_core:bucket_sap_cooked', 'bucket:bucket_empty'}},
	recipe = {
		{'sas_core:bucket_sap_cooked'},
	}
})
--[[
minetest.register_craft({
		type = 'cooking',
		output = 'sas_core:sugar 4',
		recipe = 'sas_core:bucket_sap',
		cooktime = 30,
		replacements = {{'sas_core:bucket_sap', 'bucket:bucket_empty'}},
})
]]
minetest.register_craftitem('sas_core:nesting', {
...
minetest.register_craftitem('sas_core:'..craft, {
	description = desc,
...
minetest.override_item('sas_core:dirt_with_grass',{
	drop = {
		max_items = 2,
		items = {
			{
...
minetest.register_node('sas_core:spigot', {
	description = 'spigot',
	drawtype = 'mesh',
	mesh = 'spigot.obj',
...
--	inventory_image = 'placeholder.png',
	...
	on_timer = function(pos, elapsed)
		...
		if inv:contains_item('sap', 'bucket:bucket_empty') then --make sure the bucket is still there
			inv:set_stack('sap', 1,'sas_core:bucket_sap')
...
minetest.register_node(':beds:bed_sleeping_bag', {
...
minetest.register_node(':beds:bed_leafy_bed', {
...
minetest.register_node('sas_core:sand_with_food', {
	description = 'Sand',
...
minetest.register_node('sas_core:bird_nest', {
