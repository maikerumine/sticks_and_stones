...
local tex_mod = "^[colorize:grey:9"
minetest.register_node("simple_protection:shared_chest", {
	description = S("Shared Chest  --CAUTION!  This is THE ONLY way to save your items IF in a PROTECTED area.") .. " " .. S("(by protection)"),
	tiles = {
		"default_chest_top.png^icon.png"  .. tex_mod,
