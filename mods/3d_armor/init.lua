...
dofile(modpath.."/3d_armor_ip.lua")
...
--default.player_register_model("3d_armor_character.b3d", {--mt4
player_api.register_model("3d_armor_character.b3d", {--mt5
	animation_speed = 30,
	textures = {
...
minetest.register_on_joinplayer(function(player)
	--default.player_set_model(player, "3d_armor_character.b3d")--mt4
	player_api.set_model(player, "3d_armor_character.b3d")--mt5
	minetest.after(0, function(player)
