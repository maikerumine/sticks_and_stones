...
minetest.register_alias("3d_armor:shield_wood", "shields:shield_wood")
minetest.register_alias("3d_armor:shield_enhanced_wood", "shields:shield_enhanced_wood")
minetest.register_alias("3d_armor:shield_steel", "shields:shield_steel")
