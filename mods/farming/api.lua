...
farming.register_plant = function(name, def)
	...
	local g = {seed = 1, snappy = 3, attached_node = 1, flammable = 2, dig_by_water = 1}
	...
	for i = 1, def.steps do
		...
		local nodegroups = {snappy = 3, flammable = 2, plant = 1, not_in_creative_inventory = 1, attached_node = 1, dig_by_water = 1}
		nodegroups[pname] = i
