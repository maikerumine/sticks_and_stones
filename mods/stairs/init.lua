...
stairs.register_stair_and_slab(
	"desert_stone_cobble",
	"default:desert_stone_cobble",
	{cracky = 3},
	{"darkage_desert_stone_cobble.png"},
	"Desert Stone_cobble Stair",
	"Desert Stone_cobble Slab",
	default.node_sound_stone_defaults()
)
...
stairs.register_stair_and_slab(
	"rotten_wood",
	"default:rotten_wood",
	{snappy=2, crumbly=2, choppy=2, not_in_craft_guide = 1 },
	{"rotten_wood.png"},
	"Rotten Wood Stair",
	"Rotten Wood Slab",
	default.node_sound_dirt_defaults()
