...
-- land turtle
	...
	mobs:spawn_specific("mobs:turtle",
...
-- sea turtle
	mobs:register_mob("mobs:seaturtle", {
		type = "animal",
		passive = true,
		hp_min = 20,
		hp_max = 30,
	...
	--name, nodes, neighbours, minlight, maxlight, interval, chance, active_object_count, min_height, max_height
	mobs:spawn_specific("mobs:seaturtle",
	...
	mobs:register_egg("mobs:seaturtle", "Sea Turtle", "default_water.png", 1)
