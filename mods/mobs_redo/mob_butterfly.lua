...
-- Butterfly
	mobs:register_mob("mobs:butterfly", {
		type = "animal",
		passive = true,
		hp_min = 1,
		hp_max = 2,
	...
	mobs:spawn_specific("mobs:butterfly", {"air"}, l_spawnnear, 5, 20, 30, l_spawnchance, 1, 0, 31000)
	mobs:register_egg("mobs:butterfly", "Butterfly", "default_cloud.png", 1)
