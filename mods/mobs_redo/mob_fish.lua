...
-- Clownfish
	mobs:register_mob("mobs:clownfish", {
		type = "animal",
		passive = true,
		hp_min = 1,
		hp_max = 4,
	...
	mobs:spawn_specific("mobs:clownfish", l_spawn_in, l_spawn_near, 5, 20, 30, l_spawn_chance, 1, -31000, l_water_level)
	mobs:register_egg("mobs:clownfish", "Clownfish", "animal_clownfish_clownfish_item.png", 0)

-- Tropical fish
	mobs:register_mob("mobs:tropical", {
		type = "animal",
		passive = true,
		hp_min = 1,
		hp_max = 4,
	...
	--name, nodes, neighbours, minlight, maxlight, interval, chance, active_object_count, min_height, max_height
	mobs:spawn_specific("mobs:tropical", l_spawn_in, l_spawn_near, 5, 20, 30, l_spawn_chance, 1, -31000, l_water_level)
	mobs:register_egg("mobs:tropical", "Tropical fish", "animal_fish_blue_white_fish_blue_white_item.png", 0)
