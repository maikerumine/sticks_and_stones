...
if armor.materials.fabric then
	armor:register_armor("3d_armor:helmet_fabric", {
		description = S("Fabric Helmet"),
		inventory_image = "3d_armor_inv_helmet_fabric.png",
		groups = {armor_head=1, armor_heal=0, armor_use=3000, flammable=1},
		armor_groups = {fleshy=2},
		damage_groups = {cracky=3, snappy=2, choppy=3, crumbly=2, level=1},
	})
	armor:register_armor("3d_armor:chestplate_fabric", {
		description = S("Fabric Chestplate"),
		inventory_image = "3d_armor_inv_chestplate_fabric.png",
		groups = {armor_torso=1, armor_heal=0, armor_use=3000, flammable=1},
		armor_groups = {fleshy=4},
		damage_groups = {cracky=3, snappy=2, choppy=3, crumbly=2, level=1},
	})
	armor:register_armor("3d_armor:leggings_fabric", {
		description = S("Fabric Leggings"),
		inventory_image = "3d_armor_inv_leggings_fabric.png",
		groups = {armor_legs=1, armor_heal=0, armor_use=3000, flammable=1},
		armor_groups = {fleshy=4},
		damage_groups = {cracky=3, snappy=2, choppy=3, crumbly=2, level=1},
	})
	armor:register_armor("3d_armor:boots_fabric", {
		description = S("Fabric Boots"),
		inventory_image = "3d_armor_inv_boots_fabric.png",
		armor_groups = {fleshy=2},
		damage_groups = {cracky=3, snappy=2, choppy=3, crumbly=2, level=1},
		groups = {armor_feet=1, armor_heal=0, armor_use=3000, flammable=1},
	})
end
