...
-- Licence for Code and Non-Bush leaf code is WTFPL.
  ...
  minetest.register_node("default:youngtree2_bottom", {
...
for i in pairs(BushBranchCenter) do
	...
	minetest.register_node("default:bushbranches"..Num, {
...
for i in pairs(BushLeafNode) do
	...
	minetest.register_node("default:BushLeaves"..Num, {
...
default.grow_bush = function(pos)
	...
	local bush_side_height = math.random(0,1)
		...
		if chance_of_bush_node_right> 5 then
			...
			default.grow_bush_node(right_pos,3,leaf_type)
		end
		...
		if chance_of_bush_node_left> 5 then
			...
			default.grow_bush_node(left_pos,1,leaf_type)
		end
		...
		if chance_of_bush_node_front> 5 then
			...
			default.grow_bush_node(front_pos,2,leaf_type)
		end		
		...
		if chance_of_bush_node_back> 5 then
			...
			default.grow_bush_node(back_pos,0,leaf_type)
		end
		
default.grow_bush_node(pos,5,leaf_type)
end

default.grow_bush_node = function(pos,dir, leaf_type)
	...
	or minetest.get_node(right_here).name == "default:junglegrass" then
		minetest.set_node(right_here, {name="default:bushbranches"..bush_branch_type , param2=dir})
						--minetest.chat_send_all("leaf_type: (" .. leaf_type .. ")")
		minetest.set_node(above_right_here, {name="default:BushLeaves"..leaf_type})
		local chance_of_high_leaves = math.random(1,10)
		if chance_of_high_leaves> 5 then
			local two_above_right_here = {x=pos.x, y=pos.y+3, z=pos.z}
							--minetest.chat_send_all("leaf_type: (" .. leaf_type .. ")")
			minetest.set_node(two_above_right_here, {name="default:BushLeaves"..leaf_type})
		end
	end
end
...
default:register_generate_plant({
 ...
 default.grow_youngtree2 = function(pos)
	local height = math.random(4,5)	
	default.grow_youngtree_node2(pos,height)
end

default.grow_youngtree_node2 = function(pos, height)
	...
	or minetest.get_node(right_here).name == "default:junglegrass" then
		if height == 4 then
				...
				minetest.set_node(right_here, {name="default:youngtree2_bottom"})
				minetest.set_node(above_right_here, {name="default:youngtree2_bottom"})
				minetest.set_node(two_above_right_here, {name="default:bushbranches2"  , param2=2})
				minetest.set_node(two_above_right_here_south, {name="default:bushbranches2"  , param2=0})
				minetest.set_node(three_above_right_here, {name="default:BushLeaves1" })
				minetest.set_node(three_above_right_here_south, {name="default:BushLeaves1" })
		end
