...
default_setting.func.on_show_settings = function(player_name)
	...
	minetest.show_formspec(player_name, "default:settings", formspec)
end
...
minetest.register_on_player_receive_fields(function(player, formname, fields)
	...
	if formname == "default:settings" then
		if fields["save"]  then
	...
	elseif formname == "default:admin_conf" then
		if fields["classement"] then
			local formspec = default_setting.func.get_stat()
			minetest.show_formspec(player_name, "default:classement", formspec)
...
function default_setting.func.add_to_trophies(player, fish, desc)
	...
	if string.find(fish, "_raw") ~= nil then
		...
		if default_setting.trophies[fish][player_name]%100 == 0 then
			...
			local name = "default:trophy_"..fish
...
default_setting.func.on_show_admin_menu = function(player_name)
	...
	minetest.show_formspec(player_name, "default:admin_conf", formspec)
end
...
default_setting.func.on_show_settings_contest = function(player_name)
	...
	minetest.show_formspec(player_name, "default:contest", formspec)
end

minetest.register_on_player_receive_fields(function(player, formname, fields)
	if formname == "default:contest" then
...
function default_setting.func.get_hunger_info(player_name)
	...
	minetest.show_formspec(player_name,"default:material_info", formspec)
end
