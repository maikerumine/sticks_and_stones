...
minetest.register_on_generated(function(minp, maxp, seed)
  ...
  generate_ore("default:desert_stone_with_iron", "default:desert_stone", minp, maxp, seed+0, 1/7/7/7, 3, 5, -15, 40)
  generate_claylike("default:mud", minp, maxp, seed+1, 4, 0, 2, 0)
  generate_claylike("default:silt", minp, maxp, seed+2, 4, -1, 1, 1)
  generate_stratus("default:chalk", 
                   {"default:stone"},
                   {"default:stone","air"}, nil,
                   minp, maxp, seed+3, 4, 25, 8, 0, -20,  50)
  generate_stratus("default:ors", 
                   {"default:stone"},
                   {"default:stone","air","default:water_source"}, nil,
                   minp, maxp, seed+4, 4, 25, 7, 50, -200,  500)
  generate_stratus("default:shale", 
                   {"default:stone"}, 
                   {"default:stone","air"}, nil,
                   minp, maxp, seed+5, 4, 23, 7, 50, -50,  20)
  generate_stratus("default:slate", 
                   {"default:stone"}, 
                   {"default:stone","air"}, nil,
                   minp, maxp, seed+6, 6, 23, 5, 50, -500, 0)
  generate_stratus("default:schist", 
                   {"default:stone"}, 
                   {"default:stone","air"}, nil,
  ...
  generate_stratus("default:marble", 
                   {"default:stone"},
                   {"default:stone","air"}, nil,
                   minp, maxp, seed+9, 4, 25, 6, 50, -31000,  -75)
  generate_stratus("default:serpentine", 
                   {"default:stone"},
                   {"default:stone","air"}, nil,
                   minp, maxp, seed+10, 4, 28, 8, 50, -31000,  -350)
  generate_stratus("default:gneiss", 
                   {"default:stone"}, 
                   {"default:stone","air"}, nil,
