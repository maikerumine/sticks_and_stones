...
default_setting.prizes["rivers"]["little"] = {
	{"default",  				"fish_raw",				0,			"a Fish."},
	{"default",  				"carp_raw",				0,			"a Carp."},
}

default_setting.prizes["rivers"]["big"] = {
	{"default",  				"pike_raw",				0,			"a Northern Pike."},
	{"default",  				"perch_raw",			0,			"a Perch."},
	{"default",  				"catfish_raw",			0,			"a Catfish."},
}


default_setting.prizes["sea"] = {}
default_setting.prizes["sea"]["little"] = {
	{"default",  				"clownfish_raw",		0,			"a Clownfish."},
	{"default",  				"bluewhite_raw",		0,			"a Bluewhite."},
	{"default",  				"exoticfish_raw",		0,			"a Exoticfish."},
}

default_setting.prizes["sea"]["big"] = {
	{"default",  				"shark_raw",			0,			"a small Shark."},
}
...
--	{"maptools",				"gold_coin",				0,					"a Gold Coin.",					58,			1},
	...
	{"default",					"sword_steel",				"random",			"a very old Sword.",			62,			2},
