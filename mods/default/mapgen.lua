...
function default.register_decorations()
	...
	minetest.register_decoration({
		...
		schematic = minetest.get_modpath("default") .. "/schematics/apple_tree_from_sapling.mts",
	...
	minetest.register_decoration({
		...
		--schematic = minetest.get_modpath("default") .. "/schematics/jungle_tree_from_sapling.mts",
		flags = "place_center_x, place_center_z",
		rotation = "random",
	})
	...
	minetest.register_decoration({
		deco_type = "schematic",
		place_on = {"default:dirt_with_grass", "default:dirt_with_snow", "default:dirt"},
		sidelen = 16,
		noise_params = {
			offset = -0.004,
			scale = 0.01,
		...
		biomes = {"snowy_grassland", "grassland", "deciduous_forest",
			"floatland_grassland", "rainforest"},
		y_min = 1,
		y_max = 31000,
	...
	minetest.register_decoration({
		deco_type = "simple",
		place_on = {"default:dirt", "default:dirt_with_dry_grass", "default:dirt_with_grass", "default:desert_sand", "default:clay", "default:stone", "default:snowblock"},
		sidelen = 16,
		noise_params = {
			offset = 0.003,
			scale = 0.00001,
		...
		biomes = {
			"stone_grassland", "stone_grassland_ocean", "icesheet_ocean", "icesheet",
		...
		y_min = -3,
		y_max = 60,
		decoration = "default:small_rocks1",
		--flags = "place_center_x",
		rotation = "random",
	})
	...
	minetest.register_decoration({
		...
		y_min = -3,
		y_max = 60,
		decoration = "default:small_rocks2",
		--flags = "place_center_x",
		rotation = "random",
	})
	...
	minetest.register_decoration({
		...
		y_min = -3,
		y_max = 60,
		decoration = "default:small_rocks3",
		--flags = "place_center_x",
		rotation = "random",
	})
	...
	minetest.register_decoration({
		...
		y_min = -3,
		y_max = 60,
		decoration = "default:small_rocks4",
		--flags = "place_center_x",
		rotation = "random",
	})
		--rocks
	minetest.register_decoration({
		...
		y_min = -3,
		y_max = 60,
		decoration = "default:small_rocks5",
		--flags = "place_center_x",
		rotation = "random",
	})
	...
	minetest.register_decoration({
		...
		y_min = -3,
		y_max = 60,
		decoration = "default:small_rocks6",
		--flags = "place_center_x",
		rotation = "random",
	})	
