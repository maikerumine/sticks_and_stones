...
dofile(minetest.get_modpath("default").."/molehills_settings.txt")
...
-- NoDe
-----------------------------------------------------------------------------------------------
minetest.register_node("default:molehill",{
	drawtype = "nodebox",
...
minetest.register_craft({ -- molehills --> dirt
	output = "default:dirt",
	recipe = {
		{"default:molehill","default:molehill"},
		{"default:molehill","default:molehill"},
	}
})
...
-- GeNeRaTiNG
-----------------------------------------------------------------------------------------------
default.place_molehill = function(pos)
	...
	and minetest.get_node({x=pos.x-1, y=pos.y, z=pos.z-1}).name ~= "air" then
		minetest.set_node(right_here, {name="default:molehill"})
	end
end
