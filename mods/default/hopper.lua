...
minetest.register_alias("hopper:sorter", "default:sorter")
minetest.register_alias("hopper:hopper_item", "default:hopper_item")
minetest.register_alias("hopper:hopper", "default:hopper")
minetest.register_alias("hopper:hopper_side", "default:hopper_side")
...
hopper_input["default:box"] = "main"
hopper_input["default:wood_shelves"] = "main"
hopper_input["default:sorter"] = "main"
hopper_input["default:hopper"] = "main"
hopper_input["default:furnace"] = "dst"
hopper_input["default:furnace_active"] = "dst"
hopper_input["default:bloomery"] = "dst"
hopper_input["default:bloomery_active"] = "dst"
hopper_input["default:auto_sieve"] = "dst"
hopper_input["default:auto_sieve0"] = "dst"
hopper_input["default:auto_sieve1"] = "dst"
hopper_input["default:auto_sieve2"] = "dst"
hopper_input["default:auto_sieve3"] = "dst"

local hopper_output = {}
hopper_output["default:chest"] = {"main", "main"}
hopper_output["default:box"] = {"main", "main"}
hopper_output["default:wood_shelves"] = {"main", "main"}
hopper_output["default:furnace"] = {"src", "fuel"}
hopper_output["default:furnace_active"] = {"src", "fuel"}
hopper_output["default:bloomery"] = {"src", "fuel"}
hopper_output["default:bloomery_active"] = {"src", "fuel"}
hopper_output["default:auto_sieve"] = {"src", "fuel"}
hopper_output["default:auto_sieve0"] = {"src", "fuel"}
hopper_output["default:auto_sieve1"] = {"src", "fuel"}
hopper_output["default:auto_sieve2"] = {"src", "fuel"}
hopper_output["default:auto_sieve3"] = {"src", "fuel"}
...
local function push_items(pos, opos, a)
	...
	if hopper_output[a] then
		...
		for i = 1,invsize do
			...
			local item = stack:get_name()
			if item ~= "" then
				if a == "default:furnace" or a == "default:furnace_active" then
...
minetest.register_node("default:hopper", {
	description = "Hopper",
	groups = {cracky = 1, level = 2, not_in_creative_inventory = 1},
	drop = "default:hopper_item",
	drawtype = "nodebox",
	paramtype = "light",
...
minetest.register_node("default:hopper_side", {
	description = "Hopper",
	groups = {cracky = 1, level = 2, not_in_creative_inventory = 1},
	drop = "default:hopper_item",
	drawtype = "nodebox",
...
minetest.register_node("default:sorter", {
	description = "Sorter",
	...
	on_timer = function(pos, elapsed)
		...
		if minetest.get_node(npos).name == "default:sorter" then
			ninvname = "out"
		elseif minetest.get_node(npos).name == "default:hopper_side" then
			ninvname = "main"
		elseif minetest.get_node(
				{x = pos.x, y = pos.y + 1, z = pos.z}).name == "default:hopper" then
...
minetest.register_craftitem("default:hopper_item", {
	description = "Hopper",
	...
	on_place = function(itemstack, placer, pointed_thing)
		...
		local placed = false
		if x == -1 then
			minetest.set_node(pos2, {name = "default:hopper_side", param2 = 0})
			placed = true
		elseif x == 1 then
			minetest.set_node(pos2, {name = "default:hopper_side", param2 = 2})
			placed = true
		elseif z == -1 then
			minetest.set_node(pos2, {name = "default:hopper_side", param2 = 3})
			placed = true
		elseif z == 1 then
			minetest.set_node(pos2, {name = "default:hopper_side", param2 = 1})
			placed = true
		else
			minetest.set_node(pos2, {name = "default:hopper"})
			placed = true
		end
		if placed == true then
...
minetest.register_craft({
	output = "default:hopper_item",
	recipe = {
		{"default:steel_plate","default:chest","default:steel_plate"},
		{"default:steel_plate","default:steel_spring_heavy","default:steel_plate"},
		{"default:iron_hardware","default:iron_bars","default:iron_hardware"},
	}
})

minetest.register_craft({
	output = "default:sorter",
	recipe = {
		{"default:steel_plate","default:iron_hinge","default:steel_plate"},
		{"default:iron_hardware","default:chest","default:iron_hardware"},
		{"default:steel_plate","default:steel_spring_heavy","default:steel_plate"},
	}
})
...
minetest.register_lbm({
	...
	name = "default:start_timer",
	nodenames = {"default:sorter", "default:hopper", "default:hopper_side"},
