...
default.modpath = minetest.get_modpath("plants_lib")
...
minetest.after(0, function()
	print("[Plants Lib] Registered a total of "..(#default.surfaceslist_aircheck)+(#default.surfaceslist_no_aircheck).." surface types to be evaluated, spread")
	print("[Plants Lib] across "..#default.actionslist_aircheck.." actions with air-checking and "..#default.actionslist_no_aircheck.." actions without.")
end)
