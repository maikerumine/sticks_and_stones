...
function default.register_stairs(modname, item, groups, images, description)
...
default.register_stairs("default","basalt_cobble",
	{cracky=3},
	{"darkage_basalt_cobble.png"},
	"Basalt Cobble"
)

default.register_stairs("default","slate_tale",
	{cracky=3},
	{"darkage_slate_tale.png"},
	"Slate Tale"
)

default.register_stairs("default","straw",
	 {snappy=3, flammable=2},
	{"darkage_straw.png"},
	"Straw"
)

default.register_stairs("default","stone_brick",
	{cracky=3},
	{"darkage_stone_brick.png"},
	"Stone Brick"
)

default.register_stairs("default","ors_cobble",
	{cracky=3},
	{"darkage_ors_cobble.png"},
	"Old Red Sandtone"
)

default.register_stairs("default","desert_stone_cobble",
	{cracky=3},
