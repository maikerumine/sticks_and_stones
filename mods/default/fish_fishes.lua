...
minetest.register_craftitem("default:fish_raw", {
	...
	-- Roasted Fish
	-----------------------------------------------------
	minetest.register_craftitem("default:fish_cooked", {
	...
	-- Sushi
	-----------------------------------------------------
	minetest.register_craftitem("default:sushi", {
...
-- clownfish
-----------------------------------------------------------------------------------------------
minetest.register_craftitem("default:clownfish_raw", {
...
-- bluewhite
-----------------------------------------------------------------------------------------------
minetest.register_craftitem("default:bluewhite_raw", {
...
-- exoticfish
-----------------------------------------------------------------------------------------------
minetest.register_craftitem("default:exoticfish_raw", {
...
-- carp
-----------------------------------------------------------------------------------------------
minetest.register_craftitem("default:carp_raw", {
...
-- perch
-----------------------------------------------------------------------------------------------
minetest.register_craftitem("default:perch_raw", {
...
-- catfish
-----------------------------------------------------------------------------------------------
minetest.register_craftitem("default:catfish_raw", {
...
-----------------------------------------------------------------------------------------------
minetest.register_craftitem("default:shark_raw", {
	...
	-- Roasted Shark
	-----------------------------------------------------
	minetest.register_craftitem("default:shark_cooked", {
...
-- Pike
-----------------------------------------------------------------------------------------------
minetest.register_craftitem("default:pike_raw", {
	...
	-- Roasted Pike
	-----------------------------------------------------
	minetest.register_craftitem("default:pike_cooked", {
