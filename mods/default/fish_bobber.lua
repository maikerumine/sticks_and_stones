...
-- bobber
minetest.register_node("default:bobber_box", {
	drawtype = "nodebox",
	node_box = {
		type = "fixed",
		fixed = {
...
-- WHEN RIGHTCLICKING THE BOBBER THE FOLLOWING HAPPENS (CLICK AT THE RIGHT TIME WHILE HOLDING A FISHING POLE)
	on_rightclick = function (self, clicker)
		...
		elseif item_name == "default:baitball" then
			if not default_setting.is_creative_mode then
				inv:remove_item("main", "default:baitball")
			end
			self.baitball = 20
			--addparticle
...
minetest.register_entity("default:bobber_fish_entity", FISHING_BOBBER_ENTITY)
