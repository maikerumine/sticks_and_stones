...
if default.config.enable_lady_fern == true then
	--dofile(minetest.get_modpath("default").."/pl_ferns.lua")
end

if default.config.enable_horsetails == true then
	--dofile(minetest.get_modpath("default").."/pl_ferns.lua")
end

if default.config.enable_treefern == true then
	--dofile(minetest.get_modpath("default").."/pl_ferns.lua")
end

if default.config.enable_giant_treefern == true then
	--dofile(minetest.get_modpath("default").."/pl_ferns.lua")
end
...
if run_tests then
	...
	-- Check node names
	if default.config.enable_horsetails then
		print("[Mod] " ..title.. " Checking horsetail item strings")
		assert(minetest.registered_items["default:horsetail_01"] ~= nil)
		assert(minetest.registered_items["default:horsetail_02"] ~= nil)
		assert(minetest.registered_items["default:horsetail_03"] ~= nil)
		assert(minetest.registered_items["default:horsetail_04"] ~= nil)
	end
	if default.config.enable_lady_fern then
		print("[Mod] ".. title .." Checking lady fern item strings")
		assert(minetest.registered_items["default:fern_01"] ~= nil)
		assert(minetest.registered_items["default:fern_02"] ~= nil)
		assert(minetest.registered_items["default:fern_03"] ~= nil)
	end
	if default.config.enable_treefern then
		print("[Mod] ".. title .." Checking tree fern item strings")
		assert(minetest.registered_items["default:tree_fern_leaves"] ~= nil)
		assert(minetest.registered_items["default:tree_fern_leaves_02"] ~= nil)
		assert(minetest.registered_items["default:fern_trunk"] ~= nil)
		assert(minetest.registered_items["default:sapling_tree_fern"] ~= nil)
	end
end
...
minetest.register_craft({
	type = "shapeless",
	output = "default:fiddlehead 3",
	recipe = {"default:fern_01"},
	replacements = {
		{"default:fern_01", "default:ferntuber"}
	},
})
...
minetest.register_craft({
	type = "shapeless",
	output = "default:fiddlehead 3",
	recipe = {"default:tree_fern_leaves"},
	replacements = {
		{"default:tree_fern_leaves", "default:sapling_tree_fern"}
	},
})
-----------------------------------------------------------------------------------------------
-- FIDDLEHEAD
-----------------------------------------------------------------------------------------------
minetest.register_alias("archaeplantae:fiddlehead",      "default:fiddlehead")
...
minetest.register_craft({
	type = "cooking",
	output = "default:fiddlehead_roasted",
	recipe = "default:fiddlehead",
	cooktime = 1,
})
minetest.register_craftitem("default:fiddlehead_roasted", {
...
-- FERN TUBER
-----------------------------------------------------------------------------------------------
minetest.register_alias("archaeplantae:ferntuber",      "default:ferntuber")

minetest.register_craftitem("default:ferntuber", {
	description = "Fern Tuber",
	inventory_image = "ferns_ferntuber.png",
})
minetest.register_craft({
	type = "cooking",
	output = "default:ferntuber_roasted",
	recipe = "default:ferntuber",
	cooktime = 3,
})

minetest.register_alias("archaeplantae:ferntuber_roasted",      "default:ferntuber_roasted")

minetest.register_craftitem("default:ferntuber_roasted", {
...
assert(default.config.enable_lady_fern == true)

-- Maintain backward compatibilty
minetest.register_alias("archaeplantae:fern",		"default:fern_03")
minetest.register_alias("archaeplantae:fern_mid",	"default:fern_02")
minetest.register_alias("archaeplantae:fern_small",	"default:fern_01")
minetest.register_alias("default:fern_04",      		"default:fern_02") -- for placing
	...
	for i = 1, 3 do
		...
		if i == 1 then
			node_on_place = function(itemstack, placer, pointed_thing)
				-- place a random fern
				local stack = ItemStack("default:fern_0"..math.random(1,4))
				local ret = minetest.item_place(stack, placer, pointed_thing)
				return ItemStack("default:fern_01 "..itemstack:get_count()-(1-ret:get_count()))	-- TODO FIXME?
			end
		end
		nodenames[i] = "default:fern_"..string.format("%02d", i)
...
if default.config.lady_ferns_near_tree == true then
...
if default.config.lady_ferns_near_rock == true then
	default:register_generate_plant({ -- near stone (mountains)
		surface = {
			"default:dirt_with_grass",
			"default:mossycobble",
			"group:falling_node",
...
if default.config.lady_ferns_near_ores == true then -- this one causes a huge fps drop
	default:register_generate_plant({ -- near ores (potential mining sites)
		surface = {
			"default:dirt_with_grass",
			"default:mossycobble",
...
if default.config.lady_ferns_in_groups == true then -- this one is meant as a replacement of Ferns_near_Ores
...
assert(default.config.enable_giant_treefern == true)

-- lot of code, lot to load

default.grow_giant_tree_fern = function(pos)
	local pos_01 = {x = pos.x, y = pos.y + 1, z = pos.z}
	if minetest.get_node(pos_01).name ~= "air"
			and minetest.get_node(pos_01).name ~= "default:sapling_giant_tree_fern"
	...
	for i = 1, size-3 do
		minetest.set_node({x = pos.x, y = pos.y + i, z = pos.z}, {name="default:fern_trunk_big"})
	end
	minetest.set_node({x = pos.x, y = pos.y + size-2, z = pos.z}, {name="default:fern_trunk_big_top"})
	minetest.set_node({x = pos.x, y = pos.y + size-1, z = pos.z}, {name="default:tree_fern_leaves_giant"})
	...
	for i = 1, 4 do
		...
		for j = 1, 3 do
			if minetest.get_node(positions[j]).name == "air" then
				minetest.set_node(positions[j], {name="default:tree_fern_leave_big"})
			else
				endpos = j
				break
			end
		...
		if endpos == 4 and minetest.get_node(positions[endpos]).name == "air" then
			minetest.set_node(positions[endpos], {name="default:tree_fern_leave_big_end", param2=rot})
		end
	end
end
...
-----------------------------------------------------------------------------------------------
minetest.register_node("default:tree_fern_leaves_giant", {
		...
		items = {
			{
				...
				--  reharvesting leaves)
				items = {"default:sapling_giant_tree_fern"},
				rarity = 10,
			},
			{
				items = {"default:sapling_giant_tree_fern"},
			...
			{
				items = {"default:tree_fern_leaves_giant"},
			}
		}
	},
	sounds = default.node_sound_leaves_defaults(),
...
-----------------------------------------------------------------------------------------------
minetest.register_node("default:tree_fern_leave_big", {
...
-----------------------------------------------------------------------------------------------
minetest.register_node("default:tree_fern_leave_big_end", {
...
-----------------------------------------------------------------------------------------------
minetest.register_node("default:fern_trunk_big_top", {
...
-----------------------------------------------------------------------------------------------
minetest.register_node("default:fern_trunk_big", {
	description = "Giant Fern Trunk",
	drawtype = "nodebox",
	paramtype = "light",
	tiles = {
	...
	after_destruct = function(pos,oldnode)
        ...
        if node.name == "default:fern_trunk_big" or node.name == "default:fern_trunk_big_top" then 
            minetest.dig_node({x=pos.x,y=pos.y+1,z=pos.z}) 
            minetest.add_item(pos,"default:fern_trunk_big")
        end
    end,
})
...
default.register_leafdecay({
	trunks = {"default:tree_fern_leaves_giant"},
	leaves = {"default:tree_fern_leave_big"},
	radius = 3,
})
]]
default.register_leafdecay({
	trunks = {"default:tree_fern_leave_big"},
	leaves = {"default:tree_fern_leave_big_end"},
	radius = 1,
})
--[[
default.register_leafdecay({
	trunks = {"default:fern_trunk_big"},
	leaves = {"default:tree_fern_leave_big"},
	radius = 1,
})
]]
default.register_leafdecay({
	trunks = {"default:fern_trunk_big_top"},
	leaves = {"default:tree_fern_leave_big"},
	radius = 3,
})
-----------------------------------------------------------------------------------------------
...
-----------------------------------------------------------------------------------------------
minetest.register_node("default:sapling_giant_tree_fern", {
...
minetest.register_abm({
	nodenames = "default:sapling_giant_tree_fern",
	interval = 1000,
	chance = 4,
	action = function(pos, node, _, _)
		default.grow_giant_tree_fern({x = pos.x, y = pos.y-1, z = pos.z})
    end
})
...
-- in jungles
if default.config.enable_giant_treeferns_in_jungle == true then
	default:register_generate_plant({
		surface = {
			"default:dirt_with_grass",
			"default:sand",
	...
	default.grow_giant_tree_fern
	)
end

-- for oases & tropical beaches
if default.config.enable_giant_treeferns_in_oases == true then
	default:register_generate_plant({
		surface = {
			"default:sand"--,
			--"default:desert_sand"
...
assert(default.config.enable_horsetails == true)
...
local function create_nodes()
	...
	for i = 1, 4 do
		local node_name = "default:horsetail_" .. string.format("%02d", i)
		local node_img = "ferns_horsetail_" .. string.format("%02d", i) .. ".png"
		local node_desc
		local node_on_use = nil
		local node_drop = "default:horsetail_04"
...
-- Spawning
-----------------------------------------------------------------------------------------------
if default.config.enable_horsetails_spawning == true then
...
if default.config.enable_horsetails_on_grass == true then
	default:register_generate_plant({
		surface = {
			"default:dirt_with_grass",
			"sumpf:sumpf"
...
if default.config.enable_horsetails_on_stones == true then
	default:register_generate_plant({
		surface = {
...
assert(default.config.enable_treefern == true)

default.grow_tree_fern = function(pos)

	local pos_01 = {x = pos.x, y = pos.y + 1, z = pos.z}
	if minetest.get_node(pos_01).name ~= "air"
			and minetest.get_node(pos_01).name ~= "default:sapling_tree_fern"
			and minetest.get_node(pos_01).name ~= "default:junglegrass" then
		return
	end
	...
	size = size + 1
	local crown = ({ "default:tree_fern_leaves", "default:tree_fern_leaves_02" })[math.random(1, 2)]
	...
	while (i < size-1) do
		...
		minetest.set_node({x = pos.x, y = pos.y + i, z = pos.z}, { name = "default:fern_trunk" })
		i = i + 1
	end
...
minetest.register_node("default:tree_fern_leaves", {
	description = "Tree Fern Crown (Dicksonia)",
	drawtype = "plantlike",
	visual_scale = 2,
	paramtype = "light",
		...
		items = {
			{
				...
				-- (extra saplings can also be obtained by replanting and
				--  reharvesting leaves)
				items = {"default:sapling_tree_fern"},
				rarity = 10,
			},
			{
				items = {"default:sapling_tree_fern"},
			...
			{
				items = {"default:tree_fern_leaves"},
			}
		}
	},
	sounds = default.node_sound_leaves_defaults(),
...
minetest.register_node("default:tree_fern_leaves_02", {
	drawtype = "plantlike",
	visual_scale = 2,
	paramtype = "light",
...
-- FERN TRUNK
-----------------------------------------------------------------------------------------------
minetest.register_node("default:fern_trunk", {
	...
	after_destruct = function(pos,oldnode)
        local node = minetest.get_node({x=pos.x,y=pos.y+1,z=pos.z})
        if node.name == "default:fern_trunk" then 
            minetest.dig_node({x=pos.x,y=pos.y+1,z=pos.z}) 
            minetest.add_item(pos,"default:fern_trunk")
        end
    end,
})
...
-- TREE FERN SAPLING
-----------------------------------------------------------------------------------------------
minetest.register_node("default:sapling_tree_fern", {
...
-- abm
minetest.register_abm({
	nodenames = "default:sapling_tree_fern",
	interval = 1000,
	chance = 4,
	action = function(pos, node, _, _)
		default.grow_tree_fern({x = pos.x, y = pos.y-1, z = pos.z})
    end
})
...
-- in jungles
if default.config.enable_treeferns_in_jungle == true then
	default:register_generate_plant({
		surface = {
			"default:dirt_with_grass",
			"default:sand",
	...
	default.grow_tree_fern
	)
end

-- for oases & tropical beaches
if default.config.enable_treeferns_in_oases == true then
	default:register_generate_plant({
		surface = {
			"default:sand"--,
			--"default:desert_sand"
