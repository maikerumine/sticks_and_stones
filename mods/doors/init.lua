...
doors.register("door_wood", {
		...
		recipe = {
			{"default:iron_hinge", "group:wood", "group:wood"},
			{"default:iron_hardware", "group:wood", "group:wood"},
			{"default:iron_hinge", "group:wood", "group:wood"},
		}
})
...
doors.register("door_steel", {
		...
		recipe = {
			{"default:iron_hinge", "default:steel_plate", "default:steel_plate"},
			{"default:iron_hardware", "default:steel_plate", "default:steel_plate"},
			{"default:iron_hinge", "default:steel_plate", "default:steel_plate"},
		}
})
--[[
...
minetest.register_craft({
	...
	recipe = {
		...
		{'group:wood', 'group:wood', ''},
		{'default:iron_hardware', 'default:iron_hinge', ''},
	}
})
...
function doors.register_fencegate(name, def)
	...
	minetest.register_craft({
		output = name .. "_closed",
		recipe = {
			{"default:iron_hinge", "default:iron_hardware", ""},
